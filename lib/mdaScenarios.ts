  ...
  },
  {
    ...
    phases: [
      { id: "C06-P1", title: "הערכה ראשונית", actions: [
        { id: "C06-P1-A1", text: "הערכת ABCDE ותלונת חולה", maxScore: 2 },
        { id: "C06-P1-A2", text: "מדידת סימנים חיוניים מלאה", maxScore: 2 },
        { id: "C06-P1-A3", text: "ECG 12 ערוצים – זיהוי SVT", maxScore: 2 },
        { id: "C06-P1-A4", text: "גישה ורידית והכנת אדנוזין", maxScore: 2 },
      ]},
      { id: "C06-P2", title: "טיפול", actions: [
        { id: "C06-P2-A1", text: "תמרון ואגאלי (Valsalva) – ניסיון ראשון", maxScore: 2 },
        { id: "C06-P2-A2", text: "אדנוזין 6mg IV בולוס מהיר אם תמרון נכשל", maxScore: 2 },
        { id: "C06-P2-A3", text: "אדנוזין 12mg חוזר אם אין תגובה", maxScore: 2 },
        { id: "C06-P2-A4", text: "ניטור ריתמי לאחר מתן – תיעוד המרה", maxScore: 2 },
        { id: "C06-P2-A5", text: "הכנה לקרדיוברסיה מסונכרנת אם אי-יציבות המודינמית", maxScore: 2 },
      ]},
      { id: "C06-P3", title: "פינוי", actions: [
        { id: "C06-P3-A1", text: "ניטור מתמשך ECG בנסיעה", maxScore: 2 },
        { id: "C06-P3-A2", text: "Pre-alert לחדר מיון – SVT, גיל, תגובה לטיפול", maxScore: 2 },
        { id: "C06-P3-A3", text: "תיעוד כל מנות אדנוזין והמרות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C07-P1", title: "הערכה ראשונית", actions: [
        { id: "C07-P1-A1", text: "הערכת ABCDE – זיהוי אי-יציבות המודינמית", maxScore: 2 },
        { id: "C07-P1-A2", text: "ECG 12 ערוצים – זיהוי VT קומפלקס רחב", maxScore: 2 },
        { id: "C07-P1-A3", text: "גישה ורידית, O2 במסכה, ניטור", maxScore: 2 },
        { id: "C07-P1-A4", text: "הכנת ציוד לקרדיוברסיה", maxScore: 2 },
      ]},
      { id: "C07-P2", title: "טיפול", actions: [
        { id: "C07-P2-A1", text: "קרדיוברסיה מסונכרנת 100J – חולה עם דופק ואי-יציב", maxScore: 2 },
        { id: "C07-P2-A2", text: "הרגעה/sedation לפני קרדיוברסיה (מידזולאם)", maxScore: 2 },
        { id: "C07-P2-A3", text: "בדיקת ריתמי לאחר הלם – תיעוד", maxScore: 2 },
        { id: "C07-P2-A4", text: "אמיודרון 300mg IV אם הלם נכשל", maxScore: 2 },
      ]},
      { id: "C07-P3", title: "פינוי", actions: [
        { id: "C07-P3-A1", text: "ניטור ECG מתמשך", maxScore: 2 },
        { id: "C07-P3-A2", text: "Pre-alert – VT, היסטוריה קרדיאלית, לחץ דם, טיפול", maxScore: 2 },
        { id: "C07-P3-A3", text: "מוכנות לאוסצילציה/CPR בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C08-P1", title: "הערכה ראשונית", actions: [
        { id: "C08-P1-A1", text: "מיקום חולה ישיבה זקופה – legs down", maxScore: 2 },
        { id: "C08-P1-A2", text: "O2 במסכה high-flow, שקילת CPAP", maxScore: 2 },
        { id: "C08-P1-A3", text: "ניטור SpO2, ECG, BP", maxScore: 2 },
        { id: "C08-P1-A4", text: "גישה ורידית", maxScore: 2 },
      ]},
      { id: "C08-P2", title: "טיפול", actions: [
        { id: "C08-P2-A1", text: "ניטרוגליצרין SL אם BP>100 ממ\"כ", maxScore: 2 },
        { id: "C08-P2-A2", text: "פורוסמיד 40mg IV", maxScore: 2 },
        { id: "C08-P2-A3", text: "CPAP 5-10 cmH2O אם SpO2<90% בO2 גבוה", maxScore: 2 },
        { id: "C08-P2-A4", text: "הכנה לאינטובציה אם אין שיפור", maxScore: 2 },
        { id: "C08-P2-A5", text: "ניטור תגובה לטיפול – SpO2, RR, BP", maxScore: 2 },
      ]},
      { id: "C08-P3", title: "פינוי", actions: [
        { id: "C08-P3-A1", text: "פינוי בישיבה – לא שוכב", maxScore: 2 },
        { id: "C08-P3-A2", text: "המשך CPAP בנסיעה", maxScore: 2 },
        { id: "C08-P3-A3", text: "Pre-alert – בצקת ריאות, SpO2, טיפול", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C09-P1", title: "הערכה ראשונית", actions: [
        { id: "C09-P1-A1", text: "הערכת הלם – ABCDE, skin, mentation", maxScore: 2 },
        { id: "C09-P1-A2", text: "O2 high-flow, גישה ורידית x2", maxScore: 2 },
        { id: "C09-P1-A3", text: "ECG 12 ערוצים – חיפוש STEMI", maxScore: 2 },
        { id: "C09-P1-A4", text: "ניטור מלא – ECG, SpO2, BP", maxScore: 2 },
      ]},
      { id: "C09-P2", title: "טיפול", actions: [
        { id: "C09-P2-A1", text: "אספירין 300mg PO אם STEMI/ACS", maxScore: 2 },
        { id: "C09-P2-A2", text: "נוזלים 250ml bolus זהיר אם ללא סימני עומס", maxScore: 2 },
        { id: "C09-P2-A3", text: "נורפינפרין/דופמין IV אם BP<70 ממ\"כ", maxScore: 2 },
        { id: "C09-P2-A4", text: "הימנע מניטרו ומאחרי עומס גדולים", maxScore: 2 },
      ]},
      { id: "C09-P3", title: "פינוי", actions: [
        { id: "C09-P3-A1", text: "Pre-alert קאת' מיידי – STEMI הלם קרדיוגני", maxScore: 2 },
        { id: "C09-P3-A2", text: "פינוי דחוף למרכז קאת' פעיל", maxScore: 2 },
        { id: "C09-P3-A3", text: "ניטור BP כל דקה בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C10-P1", title: "הערכה ראשונית", actions: [
        { id: "C10-P1-A1", text: "אנמנזה מלאה – אופי כאב, תנוחה, מחלה קודמת", maxScore: 2 },
        { id: "C10-P1-A2", text: "ECG 12 ערוצים – חיפוש ST elevation מפושט", maxScore: 2 },
        { id: "C10-P1-A3", text: "הבחנה מ-STEMI – saddle shape ST, PR depression", maxScore: 2 },
        { id: "C10-P1-A4", text: "האזנה – friction rub", maxScore: 2 },
      ]},
      { id: "C10-P2", title: "טיפול", actions: [
        { id: "C10-P2-A1", text: "מיקום נוח – ישיבה קדימה", maxScore: 2 },
        { id: "C10-P2-A2", text: "NSAID (איבופרופן) לאנלגזיה", maxScore: 2 },
        { id: "C10-P2-A3", text: "ניטור לסימני טמפונדה – BP, JVP, קולות לב", maxScore: 2 },
        { id: "C10-P2-A4", text: "O2 אם SpO2 ירוד", maxScore: 2 },
      ]},
      { id: "C10-P3", title: "פינוי", actions: [
        { id: "C10-P3-A1", text: "פינוי לאבחון – אקו לב, CRP, טרופונין", maxScore: 2 },
        { id: "C10-P3-A2", text: "Pre-alert – חשד פריקרדיטיס, ECG, חום", maxScore: 2 },
        { id: "C10-P3-A3", text: "ניטור לסימני דחיסת לב", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C11-P1", title: "הערכה ראשונית", actions: [
        { id: "C11-P1-A1", text: "זיהוי Beck's triad: BP נמוך, JVP גבוה, קולות מרוחקים", maxScore: 2 },
        { id: "C11-P1-A2", text: "חיפוש pulsus paradoxus (ירידת BP>10 בשאיפה)", maxScore: 2 },
        { id: "C11-P1-A3", text: "ECG – low voltage, electrical alternans", maxScore: 2 },
        { id: "C11-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "C11-P2", title: "טיפול", actions: [
        { id: "C11-P2-A1", text: "נוזלים IV זהיר לתמיכה המודינמית", maxScore: 2 },
        { id: "C11-P2-A2", text: "הימנע מBETA blocker/ניטרו", maxScore: 2 },
        { id: "C11-P2-A3", text: "פריקרדיוצנטזה – אם הכשרה ויש אולטרסאונד", maxScore: 2 },
        { id: "C11-P2-A4", text: "הכנה לניקוז דחוף בבית חולים", maxScore: 2 },
      ]},
      { id: "C11-P3", title: "פינוי", actions: [
        { id: "C11-P3-A1", text: "Pre-alert – חשד טמפונדה, Beck's triad, ממאירות", maxScore: 2 },
        { id: "C11-P3-A2", text: "פינוי דחוף לכירורגיה/קרדיולוגיה", maxScore: 2 },
        { id: "C11-P3-A3", text: "ניטור BP כל דקה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C12-P1", title: "הערכה ראשונית", actions: [
        { id: "C12-P1-A1", text: "אנמנזה – תרופות, משך תסמינים, שינוי ראיה", maxScore: 2 },
        { id: "C12-P1-A2", text: "הערכה נוירולוגית – FAST, level of consciousness", maxScore: 2 },
        { id: "C12-P1-A3", text: "מדידת BP בשתי ידיים", maxScore: 2 },
        { id: "C12-P1-A4", text: "ECG, גישה ורידית, ניטור מלא", maxScore: 2 },
      ]},
      { id: "C12-P2", title: "טיפול", actions: [
        { id: "C12-P2-A1", text: "הורדת BP הדרגתית – לא מהירה (מטרה 160/100 תוך שעה)", maxScore: 2 },
        { id: "C12-P2-A2", text: "ניטרוגליצרין SL/IV זהיר", maxScore: 2 },
        { id: "C12-P2-A3", text: "הימנע מהורדה חדה – סיכון איסכמיה מוחית", maxScore: 2 },
        { id: "C12-P2-A4", text: "הרגעת חולה, סביבה שקטה", maxScore: 2 },
      ]},
      { id: "C12-P3", title: "פינוי", actions: [
        { id: "C12-P3-A1", text: "Pre-alert – hypertensive emergency, נוירולוגיה", maxScore: 2 },
        { id: "C12-P3-A2", text: "פינוי לCT ראש ואבחון", maxScore: 2 },
        { id: "C12-P3-A3", text: "ניטור BP ותסמינים נוירולוגיים", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C13-P1", title: "הערכה ראשונית", actions: [
        { id: "C13-P1-A1", text: "אנמנזה – אופי כאב קורע, הקרנה לגב", maxScore: 2 },
        { id: "C13-P1-A2", text: "מדידת BP בשתי ידיים – חיפוש הפרש >20 ממ\"כ", maxScore: 2 },
        { id: "C13-P1-A3", text: "ECG – שלילת STEMI", maxScore: 2 },
        { id: "C13-P1-A4", text: "גישה ורידית, O2, ניטור", maxScore: 2 },
      ]},
      { id: "C13-P2", title: "טיפול", actions: [
        { id: "C13-P2-A1", text: "שמירת BP סיסטולי 100-120 – לא גבוה", maxScore: 2 },
        { id: "C13-P2-A2", text: "הימנע ממרחיבי כלים/נוזלים מוגזמים", maxScore: 2 },
        { id: "C13-P2-A3", text: "אנלגזיה – מורפין IV לכאב", maxScore: 2 },
        { id: "C13-P2-A4", text: "הימנע ממתן lytics/anticoagulants", maxScore: 2 },
      ]},
      { id: "C13-P3", title: "פינוי", actions: [
        { id: "C13-P3-A1", text: "Pre-alert – חשד ניתוק אאורטה, CT angio דחוף", maxScore: 2 },
        { id: "C13-P3-A2", text: "פינוי לבית חולים עם כירורגיה וסקולרית", maxScore: 2 },
        { id: "C13-P3-A3", text: "ניטור BP ותסמינים נוירולוגיים", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C14-P1", title: "הערכה ראשונית", actions: [
        { id: "C14-P1-A1", text: "הערכת ABCDE, תרופות, סימפטומים", maxScore: 2 },
        { id: "C14-P1-A2", text: "ECG 12 ערוצים – זיהוי בלוק AV/sick sinus", maxScore: 2 },
        { id: "C14-P1-A3", text: "גישה ורידית, ניטור מלא", maxScore: 2 },
        { id: "C14-P1-A4", text: "O2 אם SpO2 ירוד", maxScore: 2 },
      ]},
      { id: "C14-P2", title: "טיפול", actions: [
        { id: "C14-P2-A1", text: "אטרופין 0.5mg IV – מנה ראשונה", maxScore: 2 },
        { id: "C14-P2-A2", text: "אטרופין 0.5mg חוזר כל 3-5 דקות עד 3mg", maxScore: 2 },
        { id: "C14-P2-A3", text: "קצב חיצוני transcutaneous אם אטרופין נכשל", maxScore: 2 },
        { id: "C14-P2-A4", text: "דופמין/אדרנלין אם קצב חיצוני לא זמין", maxScore: 2 },
        { id: "C14-P2-A5", text: "הכנה ל-transvenous pacing בית חולים", maxScore: 2 },
      ]},
      { id: "C14-P3", title: "פינוי", actions: [
        { id: "C14-P3-A1", text: "המשך קצב חיצוני בנסיעה אם נדרש", maxScore: 2 },
        { id: "C14-P3-A2", text: "Pre-alert – ברדיקרדיה סימפטומטית, ECG, טיפול", maxScore: 2 },
        { id: "C14-P3-A3", text: "ניטור BP ודופק ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C15-P1", title: "הערכה ראשונית", actions: [
        { id: "C15-P1-A1", text: "אנמנזה – סוג קוצב, מתי הושתל, תסמינים", maxScore: 2 },
        { id: "C15-P1-A2", text: "ECG – חיפוש spikes קוצב, capture failure", maxScore: 2 },
        { id: "C15-P1-A3", text: "גישה ורידית, O2, ניטור", maxScore: 2 },
        { id: "C15-P1-A4", text: "הכנת ציוד קצב חיצוני", maxScore: 2 },
      ]},
      { id: "C15-P2", title: "טיפול", actions: [
        { id: "C15-P2-A1", text: "קצב חיצוני transcutaneous – גיבוי לקוצב כושל", maxScore: 2 },
        { id: "C15-P2-A2", text: "אטרופין 0.5mg IV כגשר", maxScore: 2 },
        { id: "C15-P2-A3", text: "הימנע ממגנט על קוצב ללא הנחייה", maxScore: 2 },
        { id: "C15-P2-A4", text: "ניטור יעילות קצב חיצוני – capture, BP", maxScore: 2 },
      ]},
      { id: "C15-P3", title: "פינוי", actions: [
        { id: "C15-P3-A1", text: "Pre-alert – כשל קוצב, ברדיקרדיה, קצב חיצוני פעיל", maxScore: 2 },
        { id: "C15-P3-A2", text: "פינוי לקרדיולוגיה/electrophysiology", maxScore: 2 },
        { id: "C15-P3-A3", text: "ניטור ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C16-P1", title: "הערכה ראשונית", actions: [
        { id: "C16-P1-A1", text: "אנמנזה – equivalent anginal (סוכרת, נשים)", maxScore: 2 },
        { id: "C16-P1-A2", text: "ECG 12 ערוצים – ST depression, T inversion", maxScore: 2 },
        { id: "C16-P1-A3", text: "גישה ורידית, ניטור, O2 אם SpO2<94%", maxScore: 2 },
        { id: "C16-P1-A4", text: "גלוקומטר – שלילת היפוגליקמיה", maxScore: 2 },
      ]},
      { id: "C16-P2", title: "טיפול", actions: [
        { id: "C16-P2-A1", text: "אספירין 300mg PO ללעיסה", maxScore: 2 },
        { id: "C16-P2-A2", text: "ניטרוגליצרין SL אם BP>100", maxScore: 2 },
        { id: "C16-P2-A3", text: "מורפין IV לכאב/אי-נוחות", maxScore: 2 },
        { id: "C16-P2-A4", text: "ניטור ECG ברציפות – זיהוי הידרדרות ל-STEMI", maxScore: 2 },
      ]},
      { id: "C16-P3", title: "פינוי", actions: [
        { id: "C16-P3-A1", text: "Pre-alert – NSTEMI, ECG, גיל, סוכרת", maxScore: 2 },
        { id: "C16-P3-A2", text: "פינוי לחדר כלילי להמשך טיפול", maxScore: 2 },
        { id: "C16-P3-A3", text: "מוכנות לAED/CPR", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C17-P1", title: "הערכה ראשונית", actions: [
        { id: "C17-P1-A1", text: "ECG 12 ערוצים + ערוצים ימניים V3R-V4R", maxScore: 2 },
        { id: "C17-P1-A2", text: "זיהוי תבנית – ST elevation ימני, ללא בצקת ריאות", maxScore: 2 },
        { id: "C17-P1-A3", text: "גישה ורידית x2, ניטור מלא", maxScore: 2 },
        { id: "C17-P1-A4", text: "הערכת JVP, צליל לב ימין", maxScore: 2 },
      ]},
      { id: "C17-P2", title: "טיפול", actions: [
        { id: "C17-P2-A1", text: "נוזלים IV 500ml bolus – חדר ימין תלוי preload", maxScore: 2 },
        { id: "C17-P2-A2", text: "הימנע מניטרו/diuretics – מסוכן!", maxScore: 2 },
        { id: "C17-P2-A3", text: "אספירין 300mg PO", maxScore: 2 },
        { id: "C17-P2-A4", text: "ניטור תגובה לנוזלים – BP, mentation", maxScore: 2 },
      ]},
      { id: "C17-P3", title: "פינוי", actions: [
        { id: "C17-P3-A1", text: "Pre-alert – STEMI חדר ימין, BP, נוזלים", maxScore: 2 },
        { id: "C17-P3-A2", text: "פינוי דחוף לקאת'", maxScore: 2 },
        { id: "C17-P3-A3", text: "ניטור BP ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C18-P1", title: "הערכה ראשונית", actions: [
        { id: "C18-P1-A1", text: "אישור ROSC – דופק, BP, ריתמי", maxScore: 2 },
        { id: "C18-P1-A2", text: "ניהול נתיב אוויר – אינטובציה/SGA", maxScore: 2 },
        { id: "C18-P1-A3", text: "SpO2 מטרה 94-98%, EtCO2 35-45", maxScore: 2 },
        { id: "C18-P1-A4", text: "ECG 12 ערוצים – חיפוש STEMI", maxScore: 2 },
      ]},
      { id: "C18-P2", title: "טיפול post-ROSC", actions: [
        { id: "C18-P2-A1", text: "מניעת היפוקסיה והיפרוקסיה – ניהול O2 מדויק", maxScore: 2 },
        { id: "C18-P2-A2", text: "BP מטרה >100 systolic – נוזלים/וזופרסורים", maxScore: 2 },
        { id: "C18-P2-A3", text: "גלוקוז – שמירה 6-10 mmol/L", maxScore: 2 },
        { id: "C18-P2-A4", text: "Targeted Temperature Management – הכנה", maxScore: 2 },
        { id: "C18-P2-A5", text: "מוכנות ל-re-arrest בנסיעה", maxScore: 2 },
      ]},
      { id: "C18-P3", title: "פינוי", actions: [
        { id: "C18-P3-A1", text: "Pre-alert – ROSC post VF, STEMI?, תצורת טיפול", maxScore: 2 },
        { id: "C18-P3-A2", text: "פינוי לקאת' ו/או ICU", maxScore: 2 },
        { id: "C18-P3-A3", text: "ניטור EtCO2, SpO2, BP ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C19-P1", title: "הערכה ראשונית", actions: [
        { id: "C19-P1-A1", text: "ECG – אישור AF, קצב חדרי, מורפולוגיית QRS", maxScore: 2 },
        { id: "C19-P1-A2", text: "הערכת יציבות המודינמית", maxScore: 2 },
        { id: "C19-P1-A3", text: "אנמנזה – משך, anticoagulation, תרופות", maxScore: 2 },
        { id: "C19-P1-A4", text: "גישה ורידית, ניטור, O2", maxScore: 2 },
      ]},
      { id: "C19-P2", title: "טיפול", actions: [
        { id: "C19-P2-A1", text: "AF יציב – rate control: metoprolol/digoxin IV", maxScore: 2 },
        { id: "C19-P2-A2", text: "AF עם אי-יציבות – קרדיוברסיה מסונכרנת 120-200J", maxScore: 2 },
        { id: "C19-P2-A3", text: "O2 לפי SpO2, מניעת CHF", maxScore: 2 },
        { id: "C19-P2-A4", text: "ניטור תגובה לטיפול", maxScore: 2 },
      ]},
      { id: "C19-P3", title: "פינוי", actions: [
        { id: "C19-P3-A1", text: "Pre-alert – AF RVR, יציבות, טיפול", maxScore: 2 },
        { id: "C19-P3-A2", text: "פינוי לקרדיולוגיה", maxScore: 2 },
        { id: "C19-P3-A3", text: "ניטור ECG ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "C20-P1", title: "הערכה ראשונית", actions: [
        { id: "C20-P1-A1", text: "ECG – מדידת QRS, אקסיס, מורפולוגיה", maxScore: 2 },
        { id: "C20-P1-A2", text: "הנחת VT עד הוכחת היפך", maxScore: 2 },
        { id: "C20-P1-A3", text: "הערכת יציבות המודינמית", maxScore: 2 },
        { id: "C20-P1-A4", text: "גישה ורידית, ניטור, O2", maxScore: 2 },
      ]},
      { id: "C20-P2", title: "טיפול", actions: [
        { id: "C20-P2-A1", text: "אם אי-יציב – קרדיוברסיה מסונכרנת מיידית", maxScore: 2 },
        { id: "C20-P2-A2", text: "אם יציב – אמיודרון 150mg IV על 10 דקות", maxScore: 2 },
        { id: "C20-P2-A3", text: "הימנע מ-calcium channel blockers (Verapamil) – סכנה ב-VT", maxScore: 2 },
        { id: "C20-P2-A4", text: "ניטור תגובה – ריתמי, BP", maxScore: 2 },
      ]},
      { id: "C20-P3", title: "פינוי", actions: [
        { id: "C20-P3-A1", text: "Pre-alert – wide complex tachycardia, טיפול", maxScore: 2 },
        { id: "C20-P3-A2", text: "פינוי לאבחון מלא – אלקטרופיזיולוגיה", maxScore: 2 },
        { id: "C20-P3-A3", text: "ניטור ECG ברציפות, מוכנות ל-re-arrest", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R05-P1", title: "הערכה ראשונית", actions: [
        { id: "R05-P1-A1", text: "זיהוי אנפילקסיס – עקיצה, stridor, BP נמוך, פריחה", maxScore: 2 },
        { id: "R05-P1-A2", text: "הכנת אדרנלין 1:1000 IM מיידי", maxScore: 2 },
        { id: "R05-P1-A3", text: "O2 high-flow במסכה", maxScore: 2 },
        { id: "R05-P1-A4", text: "גישה ורידית מהירה x2", maxScore: 2 },
      ]},
      { id: "R05-P2", title: "טיפול", actions: [
        { id: "R05-P2-A1", text: "אדרנלין 0.5mg IM (1:1000) לירך חיצוני", maxScore: 2 },
        { id: "R05-P2-A2", text: "נוזלים IV 500-1000ml bolus", maxScore: 2 },
        { id: "R05-P2-A3", text: "סלבוטמול נבולייזר לברונכוספזם", maxScore: 2 },
        { id: "R05-P2-A4", text: "הידרוקורטיזון 200mg IV ו-כלורפנירמין 10mg IV", maxScore: 2 },
        { id: "R05-P2-A5", text: "מנה שנייה אדרנלין IM אחרי 5 דקות אם ללא שיפור", maxScore: 2 },
      ]},
      { id: "R05-P3", title: "פינוי", actions: [
        { id: "R05-P3-A1", text: "פינוי דחוף – ניטור לrebound reaction", maxScore: 2 },
        { id: "R05-P3-A2", text: "Pre-alert – אנפילקסיס, אדרנלין, BP", maxScore: 2 },
        { id: "R05-P3-A3", text: "הכנה לאינטובציה אם stridor מחמיר", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R06-P1", title: "הערכה ראשונית", actions: [
        { id: "R06-P1-A1", text: "הערכת נשימה – accessory muscles, cyanosis, mentation", maxScore: 2 },
        { id: "R06-P1-A2", text: "O2 מבוקר – מטרה SpO2 88-92% ב-COPD", maxScore: 2 },
        { id: "R06-P1-A3", text: "האזנה – wheeze, air entry", maxScore: 2 },
        { id: "R06-P1-A4", text: "גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "R06-P2", title: "טיפול", actions: [
        { id: "R06-P2-A1", text: "סלבוטמול 2.5-5mg נבולייזר", maxScore: 2 },
        { id: "R06-P2-A2", text: "איפרטרופיום (Atrovent) 0.5mg נבולייזר", maxScore: 2 },
        { id: "R06-P2-A3", text: "מתיל-פרדניזולון 125mg IV", maxScore: 2 },
        { id: "R06-P2-A4", text: "NIV/BiPAP אם מחמיר – pH<7.35, CO2 גבוה", maxScore: 2 },
        { id: "R06-P2-A5", text: "הכנה לאינטובציה כמוצא אחרון", maxScore: 2 },
      ]},
      { id: "R06-P3", title: "פינוי", actions: [
        { id: "R06-P3-A1", text: "המשך O2 מבוקר וNIV בנסיעה", maxScore: 2 },
        { id: "R06-P3-A2", text: "Pre-alert – COPD exacerbation, SpO2, BiPAP", maxScore: 2 },
        { id: "R06-P3-A3", text: "ניטור SpO2, mentation, RR", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R07-P1", title: "הערכה ראשונית", actions: [
        { id: "R07-P1-A1", text: "האזנה דו-צדדית – הפחתת כניסת אוויר צד אחד", maxScore: 2 },
        { id: "R07-P1-A2", text: "הקשה – היפר-רזוננס בצד הפגוע", maxScore: 2 },
        { id: "R07-P1-A3", text: "O2 high-flow, ניטור SpO2", maxScore: 2 },
        { id: "R07-P1-A4", text: "זיהוי פנאומוטורקס פשוט vs tension", maxScore: 2 },
      ]},
      { id: "R07-P2", title: "טיפול", actions: [
        { id: "R07-P2-A1", text: "פנאומוטורקס פשוט – O2, ניטור, פינוי", maxScore: 2 },
        { id: "R07-P2-A2", text: "פנאומוטורקס מתח – ניקוב מיידי מחט 2nd ICS MCL", maxScore: 2 },
        { id: "R07-P2-A3", text: "זיהוי סימני tension: tracheal deviation, ורידי צוואר", maxScore: 2 },
        { id: "R07-P2-A4", text: "לאחר ניקוב – הכנה לצינור חזה בבית חולים", maxScore: 2 },
      ]},
      { id: "R07-P3", title: "פינוי", actions: [
        { id: "R07-P3-A1", text: "Pre-alert – פנאומוטורקס, ניקוב אם בוצע, SpO2", maxScore: 2 },
        { id: "R07-P3-A2", text: "פינוי לכירורגיה לצינור חזה", maxScore: 2 },
        { id: "R07-P3-A3", text: "ניטור SpO2, BP, mentation", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R08-P1", title: "הערכה ראשונית", actions: [
        { id: "R08-P1-A1", text: "אנמנזה – DVT גורמי סיכון, טיסה, immobility", maxScore: 2 },
        { id: "R08-P1-A2", text: "בדיקת גפיים – DVT סימנים", maxScore: 2 },
        { id: "R08-P1-A3", text: "ECG – S1Q3T3, sinus tachycardia", maxScore: 2 },
        { id: "R08-P1-A4", text: "O2 high-flow, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "R08-P2", title: "טיפול", actions: [
        { id: "R08-P2-A1", text: "O2 לפי SpO2, מטרה >94%", maxScore: 2 },
        { id: "R08-P2-A2", text: "נוזלים IV זהיר – אם BP נמוך", maxScore: 2 },
        { id: "R08-P2-A3", text: "הימנע מהורדת preload – ניטרו, diuretics", maxScore: 2 },
        { id: "R08-P2-A4", text: "אנלגזיה לכאב פלאוריטי", maxScore: 2 },
        { id: "R08-P2-A5", text: "PE המסיבי + הלם – שקילת lytics", maxScore: 2 },
      ]},
      { id: "R08-P3", title: "פינוי", actions: [
        { id: "R08-P3-A1", text: "Pre-alert – חשד PE, SpO2, יציבות", maxScore: 2 },
        { id: "R08-P3-A2", text: "פינוי לCT angio ריאות", maxScore: 2 },
        { id: "R08-P3-A3", text: "ניטור ברציפות – מוכנות לאוסצילציה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R09-P1", title: "הערכה ראשונית", actions: [
        { id: "R09-P1-A1", text: "O2 100% NRB מיידי – CO poisoning בכל חולה שריפה", maxScore: 2 },
        { id: "R09-P1-A2", text: "הערכת נתיב אוויר – stridor, קול צרוד, ריסים שרופים", maxScore: 2 },
        { id: "R09-P1-A3", text: "זיהוי SpO2 לא אמין ב-CO – COHb גבוה", maxScore: 2 },
        { id: "R09-P1-A4", text: "גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "R09-P2", title: "טיפול", actions: [
        { id: "R09-P2-A1", text: "O2 100% NRB ברציפות – הפחתת t1/2 CO", maxScore: 2 },
        { id: "R09-P2-A2", text: "הכנה לאינטובציה מוקדמת – בצקת airway מתפתחת", maxScore: 2 },
        { id: "R09-P2-A3", text: "RSI מוקדם אם stridor/קול צרוד מחמיר", maxScore: 2 },
        { id: "R09-P2-A4", text: "נוזלים IV, ניטור לפי צרכים", maxScore: 2 },
      ]},
      { id: "R09-P3", title: "פינוי", actions: [
        { id: "R09-P3-A1", text: "Pre-alert – שאיפת עשן, airway compromise, אינטובציה", maxScore: 2 },
        { id: "R09-P3-A2", text: "פינוי לחדר כוויות/ICU", maxScore: 2 },
        { id: "R09-P3-A3", text: "שקילת hyperbaric O2 ב-CO קשה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R10-P1", title: "הערכה ראשונית", actions: [
        { id: "R10-P1-A1", text: "הערכת ABCDE – airway, breathing, circulation", maxScore: 2 },
        { id: "R10-P1-A2", text: "ניהול נתיב אוויר – הטיה, BVM, שאיבה", maxScore: 2 },
        { id: "R10-P1-A3", text: "O2 100%, BVM עם PEEP", maxScore: 2 },
        { id: "R10-P1-A4", text: "ניטור טמפרטורה – היפותרמיה", maxScore: 2 },
      ]},
      { id: "R10-P2", title: "טיפול", actions: [
        { id: "R10-P2-A1", text: "RSI/אינטובציה – airway protection", maxScore: 2 },
        { id: "R10-P2-A2", text: "היפותרמיה – לא להכריז מוות עד חום תקין", maxScore: 2 },
        { id: "R10-P2-A3", text: "גישה ורידית/IO – נוזלים חמים", maxScore: 2 },
        { id: "R10-P2-A4", text: "CPR אם PEA/asystole", maxScore: 2 },
        { id: "R10-P2-A5", text: "ניטור גלוקוז, אלקטרוליטים (הערכה)", maxScore: 2 },
      ]},
      { id: "R10-P3", title: "פינוי", actions: [
        { id: "R10-P3-A1", text: "Pre-alert – near drowning, גיל, היפותרמיה, אינטובציה", maxScore: 2 },
        { id: "R10-P3-A2", text: "פינוי מהיר לICU ילדים", maxScore: 2 },
        { id: "R10-P3-A3", text: "חימום פעיל בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R11-P1", title: "הערכה ראשונית", actions: [
        { id: "R11-P1-A1", text: "זיהוי הצגה – drooling, stridor, sniffing position", maxScore: 2 },
        { id: "R11-P1-A2", text: "O2 high-flow בעדינות – לא לאלץ מיקום", maxScore: 2 },
        { id: "R11-P1-A3", text: "הימנע מבדיקת גרון עם spatula – סיכון spasm", maxScore: 2 },
        { id: "R11-P1-A4", text: "הכנה לניהול airway קשה", maxScore: 2 },
      ]},
      { id: "R11-P2", title: "טיפול", actions: [
        { id: "R11-P2-A1", text: "O2 humidified, מיקום נוח לחולה", maxScore: 2 },
        { id: "R11-P2-A2", text: "הכנה לאינטובציה RSI על ידי מנוסה בairway קשה", maxScore: 2 },
        { id: "R11-P2-A3", text: "הכנה ל-cricothyrotomy כמוצא אחרון", maxScore: 2 },
        { id: "R11-P2-A4", text: "גישה ורידית, אדרנלין IM אם אנפילקסיס בDDx", maxScore: 2 },
      ]},
      { id: "R11-P3", title: "פינוי", actions: [
        { id: "R11-P3-A1", text: "Pre-alert – חשד אפיגלוטיטיס, airway מסוכן, אנסתזיה", maxScore: 2 },
        { id: "R11-P3-A2", text: "פינוי מהיר עם רופא/אנסתזיולוג", maxScore: 2 },
        { id: "R11-P3-A3", text: "לא לעזוב חולה רגע", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R12-P1", title: "הערכה ראשונית", actions: [
        { id: "R12-P1-A1", text: "הרגעת ילד והורים – distress מחמיר stridor", maxScore: 2 },
        { id: "R12-P1-A2", text: "O2 humidified מרחוק (blow-by) – לא מסכה צמודה", maxScore: 2 },
        { id: "R12-P1-A3", text: "ציון Westley – חומרת קרופ", maxScore: 2 },
        { id: "R12-P1-A4", text: "הבחנה מאפיגלוטיטיס – שיעול נביחה, קול צרוד", maxScore: 2 },
      ]},
      { id: "R12-P2", title: "טיפול", actions: [
        { id: "R12-P2-A1", text: "אדרנלין (1:1000) 5ml נבולייזר", maxScore: 2 },
        { id: "R12-P2-A2", text: "דקסמתזון 0.15mg/kg PO/IM", maxScore: 2 },
        { id: "R12-P2-A3", text: "O2 אם SpO2<94%", maxScore: 2 },
        { id: "R12-P2-A4", text: "הכנה לאינטובציה אם מחמיר", maxScore: 2 },
      ]},
      { id: "R12-P3", title: "פינוי", actions: [
        { id: "R12-P3-A1", text: "Pre-alert – קרופ, גיל, Westley, אדרנלין", maxScore: 2 },
        { id: "R12-P3-A2", text: "פינוי – rebound אחרי אדרנלין, ניטור 2-4 שעות", maxScore: 2 },
        { id: "R12-P3-A3", text: "ניטור SpO2, stridor, mentation", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R13-P1", title: "הערכה ראשונית", actions: [
        { id: "R13-P1-A1", text: "כמות ומקור – massive hemoptysis הגדרה >200ml/24h", maxScore: 2 },
        { id: "R13-P1-A2", text: "O2 high-flow, גישה ורידית x2", maxScore: 2 },
        { id: "R13-P1-A3", text: "מיקום – צד הפגוע למטה לדלף לריאה בריאה", maxScore: 2 },
        { id: "R13-P1-A4", text: "ניטור SpO2, BP, mentation", maxScore: 2 },
      ]},
      { id: "R13-P2", title: "טיפול", actions: [
        { id: "R13-P2-A1", text: "נוזלים IV לתמיכה המודינמית", maxScore: 2 },
        { id: "R13-P2-A2", text: "הכנה לאינטובציה – single lung ventilation אם מחמיר", maxScore: 2 },
        { id: "R13-P2-A3", text: "לא מתן anticoagulants", maxScore: 2 },
        { id: "R13-P2-A4", text: "שאיבת דרכי אוויר", maxScore: 2 },
      ]},
      { id: "R13-P3", title: "פינוי", actions: [
        { id: "R13-P3-A1", text: "Pre-alert – massive hemoptysis, SpO2, אינטובציה", maxScore: 2 },
        { id: "R13-P3-A2", text: "פינוי לכירורגיה/interventional radiology", maxScore: 2 },
        { id: "R13-P3-A3", text: "ניטור ברציפות, מוכנות לCPR", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R14-P1", title: "הערכה ראשונית", actions: [
        { id: "R14-P1-A1", text: "הערכת עייפות נשימתית – accessory muscles, paradoxical", maxScore: 2 },
        { id: "R14-P1-A2", text: "EtCO2 אם זמין – ריטנציית CO2", maxScore: 2 },
        { id: "R14-P1-A3", text: "O2 נמוך ל-COPD, גישה ורידית", maxScore: 2 },
        { id: "R14-P1-A4", text: "ניטור SpO2, BP, GCS", maxScore: 2 },
      ]},
      { id: "R14-P2", title: "טיפול", actions: [
        { id: "R14-P2-A1", text: "BiPAP: IPAP 12-16, EPAP 4-8 cmH2O", maxScore: 2 },
        { id: "R14-P2-A2", text: "ברונכודילטור במקביל נבולייזר", maxScore: 2 },
        { id: "R14-P2-A3", text: "ניטור תגובה – SpO2, RR, mentation שיפור", maxScore: 2 },
        { id: "R14-P2-A4", text: "הכנה לאינטובציה אם BiPAP נכשל", maxScore: 2 },
      ]},
      { id: "R14-P3", title: "פינוי", actions: [
        { id: "R14-P3-A1", text: "המשך BiPAP בנסיעה", maxScore: 2 },
        { id: "R14-P3-A2", text: "Pre-alert – NIV failure risk, COPD/CHF, SpO2", maxScore: 2 },
        { id: "R14-P3-A3", text: "ניטור ברציפות, מוכנות לאינטובציה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R15-P1", title: "הערכה ראשונית", actions: [
        { id: "R15-P1-A1", text: "זיהוי happy hypoxia – SpO2 נמוך ללא distress קשה", maxScore: 2 },
        { id: "R15-P1-A2", text: "O2 NRB/High flow, מטרה SpO2>94%", maxScore: 2 },
        { id: "R15-P1-A3", text: "prone position אם ניתן – שיפור oxygenation", maxScore: 2 },
        { id: "R15-P1-A4", text: "גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "R15-P2", title: "טיפול", actions: [
        { id: "R15-P2-A1", text: "O2 high-flow nasal cannula (HFNC) אם זמין", maxScore: 2 },
        { id: "R15-P2-A2", text: "prone positioning לשיפור V/Q", maxScore: 2 },
        { id: "R15-P2-A3", text: "נוזלים זהיר – ARDS נוטה לoverfill", maxScore: 2 },
        { id: "R15-P2-A4", text: "הכנה לאינטובציה – SpO2<90% בO2 מקסימלי", maxScore: 2 },
      ]},
      { id: "R15-P3", title: "פינוי", actions: [
        { id: "R15-P3-A1", text: "Pre-alert – COVID pneumonia, happy hypoxia, SpO2", maxScore: 2 },
        { id: "R15-P3-A2", text: "פינוי לICU – ARDS protocol", maxScore: 2 },
        { id: "R15-P3-A3", text: "ניטור SpO2 ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R16-P1", title: "הערכה ראשונית", actions: [
        { id: "R16-P1-A1", text: "האזנה – אי-שמיעת נשימה בצד + עמעום", maxScore: 2 },
        { id: "R16-P1-A2", text: "O2 high-flow, מיקום ישיבה", maxScore: 2 },
        { id: "R16-P1-A3", text: "FAST/Lung US אם זמין – עמידת נוזל", maxScore: 2 },
        { id: "R16-P1-A4", text: "ניטור SpO2, BP, mentation", maxScore: 2 },
      ]},
      { id: "R16-P2", title: "טיפול", actions: [
        { id: "R16-P2-A1", text: "O2 לפי SpO2, מיקום נוח", maxScore: 2 },
        { id: "R16-P2-A2", text: "ניקוז pleural – אם מיומן ויש ציוד ועמידת נוזל", maxScore: 2 },
        { id: "R16-P2-A3", text: "הבחנה מפנאומוטורקס – עמעום vs היפר-רזוננס", maxScore: 2 },
        { id: "R16-P2-A4", text: "ניטור תגובה לO2", maxScore: 2 },
      ]},
      { id: "R16-P3", title: "פינוי", actions: [
        { id: "R16-P3-A1", text: "Pre-alert – תפיחת ריאות, ממאירות, SpO2", maxScore: 2 },
        { id: "R16-P3-A2", text: "פינוי לניקוז בבית חולים", maxScore: 2 },
        { id: "R16-P3-A3", text: "ניטור SpO2 ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R17-P1", title: "הערכה ראשונית", actions: [
        { id: "R17-P1-A1", text: "הערכת חומרת התקף אסתמה", maxScore: 2 },
        { id: "R17-P1-A2", text: "מיקום שמאל – הרחבת לחץ IVC בהריון", maxScore: 2 },
        { id: "R17-P1-A3", text: "O2 high-flow – מטרה SpO2>95% בהריון!", maxScore: 2 },
        { id: "R17-P1-A4", text: "גישה ורידית, ניטור FHR אם ניתן", maxScore: 2 },
      ]},
      { id: "R17-P2", title: "טיפול", actions: [
        { id: "R17-P2-A1", text: "סלבוטמול נבולייזר – בטוח בהריון", maxScore: 2 },
        { id: "R17-P2-A2", text: "מגנזיום סולפט 2g IV – bronchodilator", maxScore: 2 },
        { id: "R17-P2-A3", text: "הידרוקורטיזון 200mg IV", maxScore: 2 },
        { id: "R17-P2-A4", text: "הכנה לאינטובציה אם מחמיר – RSI מיוחד להריון", maxScore: 2 },
      ]},
      { id: "R17-P3", title: "פינוי", actions: [
        { id: "R17-P3-A1", text: "Pre-alert – אסתמה חמורה + הריון, SpO2, שבוע הריון", maxScore: 2 },
        { id: "R17-P3-A2", text: "פינוי לחדר לידה + ריאות", maxScore: 2 },
        { id: "R17-P3-A3", text: "ניטור SpO2 מטרה >95%", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R18-P1", title: "הערכה ראשונית", actions: [
        { id: "R18-P1-A1", text: "שלילת אבחנות מסכנות חיים – PE, MI, פנאומוטורקס", maxScore: 2 },
        { id: "R18-P1-A2", text: "אנמנזה מלאה – טריגר, היסטוריה, תרופות", maxScore: 2 },
        { id: "R18-P1-A3", text: "גלוקומטר, ECG, SpO2 – שלילת אורגני", maxScore: 2 },
        { id: "R18-P1-A4", text: "הרגעה, הסבר לחולה", maxScore: 2 },
      ]},
      { id: "R18-P2", title: "טיפול", actions: [
        { id: "R18-P2-A1", text: "הנחיית נשימה – slow breathing, diaphragmatic", maxScore: 2 },
        { id: "R18-P2-A2", text: "הימנע ממסכה עם שקית נייר – סיכון", maxScore: 2 },
        { id: "R18-P2-A3", text: "הרגעת סביבה, הוצאת גורמי לחץ", maxScore: 2 },
        { id: "R18-P2-A4", text: "לא O2 נוסף – SpO2 כבר תקינה", maxScore: 2 },
      ]},
      { id: "R18-P3", title: "פינוי", actions: [
        { id: "R18-P3-A1", text: "פינוי לאבחון שלמות – שלילת PE בחולה ראשונה", maxScore: 2 },
        { id: "R18-P3-A2", text: "תיעוד – תגובה לטיפול הרגעתי", maxScore: 2 },
        { id: "R18-P3-A3", text: "הפניה לתמיכה נפשית", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "R19-P1", title: "הערכה ראשונית", actions: [
        { id: "R19-P1-A1", text: "MARCH/ABCDE – trauma survey", maxScore: 2 },
        { id: "R19-P1-A2", text: "הערכת flail chest – תנועה פרדוקסלית", maxScore: 2 },
        { id: "R19-P1-A3", text: "O2 high-flow, ניטור SpO2", maxScore: 2 },
        { id: "R19-P1-A4", text: "שלילת פנאומוטורקס/המוטורקס", maxScore: 2 },
      ]},
      { id: "R19-P2", title: "טיפול", actions: [
        { id: "R19-P2-A1", text: "אנלגזיה IV – מורפין/קטמין לאפשר נשימה יעילה", maxScore: 2 },
        { id: "R19-P2-A2", text: "Flail chest – IPPV/CPAP לstabilization", maxScore: 2 },
        { id: "R19-P2-A3", text: "לא splinting חיצוני – מגביל נשימה", maxScore: 2 },
        { id: "R19-P2-A4", text: "נוזלים זהיר – ריאה קוסנטוסית", maxScore: 2 },
      ]},
      { id: "R19-P3", title: "פינוי", actions: [
        { id: "R19-P3-A1", text: "Pre-alert – טראומת חזה, flail, SpO2, אנלגזיה", maxScore: 2 },
        { id: "R19-P3-A2", text: "פינוי לטראומה – X ray, CT חזה", maxScore: 2 },
        { id: "R19-P3-A3", text: "ניטור SpO2, BP, RR ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N04-P1", title: "הערכה ראשונית", actions: [
        { id: "N04-P1-A1", text: "FAST – גם אם חלף, תיעוד סימנים קודמים", maxScore: 2 },
        { id: "N04-P1-A2", text: "NIHSS – הערכה נוירולוגית מלאה", maxScore: 2 },
        { id: "N04-P1-A3", text: "גלוקומטר – שלילת היפוגליקמיה", maxScore: 2 },
        { id: "N04-P1-A4", text: "ECG – חיפוש AF", maxScore: 2 },
      ]},
      { id: "N04-P2", title: "טיפול", actions: [
        { id: "N04-P2-A1", text: "O2 אם SpO2<94%", maxScore: 2 },
        { id: "N04-P2-A2", text: "גישה ורידית, ניטור", maxScore: 2 },
        { id: "N04-P2-A3", text: "לא lytics – תסמינים חלפו", maxScore: 2 },
        { id: "N04-P2-A4", text: "אספירין 300mg PO – antiplatelets", maxScore: 2 },
      ]},
      { id: "N04-P3", title: "פינוי", actions: [
        { id: "N04-P3-A1", text: "Pre-alert – TIA, ABCD2 score, ECG, גלוקוז", maxScore: 2 },
        { id: "N04-P3-A2", text: "פינוי דחוף – TIA = stroke בהמתנה", maxScore: 2 },
        { id: "N04-P3-A3", text: "ניטור לסימני stroke בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N05-P1", title: "הערכה ראשונית", actions: [
        { id: "N05-P1-A1", text: "NIHSS, GCS, הערכה נוירולוגית מלאה", maxScore: 2 },
        { id: "N05-P1-A2", text: "מדידת BP בשתי ידיים", maxScore: 2 },
        { id: "N05-P1-A3", text: "גלוקומטר, ECG, ניטור", maxScore: 2 },
        { id: "N05-P1-A4", text: "גישה ורידית", maxScore: 2 },
      ]},
      { id: "N05-P2", title: "טיפול", actions: [
        { id: "N05-P2-A1", text: "הורדת BP הדרגתית – מטרה 25% תוך שעה", maxScore: 2 },
        { id: "N05-P2-A2", text: "ניטרוגליצרין IV זהיר / labetalol IV", maxScore: 2 },
        { id: "N05-P2-A3", text: "הימנע מהורדה מהירה – CVA!", maxScore: 2 },
        { id: "N05-P2-A4", text: "O2 לפי SpO2", maxScore: 2 },
      ]},
      { id: "N05-P3", title: "פינוי", actions: [
        { id: "N05-P3-A1", text: "Pre-alert – hypertensive encephalopathy, BP, GCS", maxScore: 2 },
        { id: "N05-P3-A2", text: "פינוי לCT ראש ונוירולוגיה", maxScore: 2 },
        { id: "N05-P3-A3", text: "ניטור BP ותסמינים נוירולוגיים", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N06-P1", title: "הערכה ראשונית", actions: [
        { id: "N06-P1-A1", text: "אנמנזה – פרכוס קודם, אפילפסיה, תרופות", maxScore: 2 },
        { id: "N06-P1-A2", text: "FAST – הבחנה מ-CVA אמיתי", maxScore: 2 },
        { id: "N06-P1-A3", text: "גלוקומטר – שלילת היפוגליקמיה", maxScore: 2 },
        { id: "N06-P1-A4", text: "גישה ורידית, ניטור, O2", maxScore: 2 },
      ]},
      { id: "N06-P2", title: "טיפול", actions: [
        { id: "N06-P2-A1", text: "ניטור הדרגתי – Todd's משתפר תוך דקות-שעות", maxScore: 2 },
        { id: "N06-P2-A2", text: "לא lytics – Todd's ולא CVA אמיתי", maxScore: 2 },
        { id: "N06-P2-A3", text: "הגנת airway אם הכרה ירודה", maxScore: 2 },
        { id: "N06-P2-A4", text: "תיעוד הפרכוס, נסיבות, עדי ראייה", maxScore: 2 },
      ]},
      { id: "N06-P3", title: "פינוי", actions: [
        { id: "N06-P3-A1", text: "Pre-alert – post-ictal weakness, היסטוריה, FAST", maxScore: 2 },
        { id: "N06-P3-A2", text: "פינוי לCT ראש – שלילת bleed", maxScore: 2 },
        { id: "N06-P3-A3", text: "ניטור שיפור נוירולוגי בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N07-P1", title: "הערכה ראשונית", actions: [
        { id: "N07-P1-A1", text: "GCS serial, NIHSS, pupil check", maxScore: 2 },
        { id: "N07-P1-A2", text: "אנמנזה – warfarin, נפילה, אמנזיה", maxScore: 2 },
        { id: "N07-P1-A3", text: "Cushing's triad – BP גבוה, bradycardia, irregular breathing", maxScore: 2 },
        { id: "N07-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "N07-P2", title: "טיפול", actions: [
        { id: "N07-P2-A1", text: "ניהול airway – אינטובציה אם GCS≤8", maxScore: 2 },
        { id: "N07-P2-A2", text: "ראש 30° למעלה – הפחתת ICP", maxScore: 2 },
        { id: "N07-P2-A3", text: "מניטול 1g/kg IV אם herniation", maxScore: 2 },
        { id: "N07-P2-A4", text: "Reversal warfarin – K, FFP, PCC (ב-BH)", maxScore: 2 },
      ]},
      { id: "N07-P3", title: "פינוי", actions: [
        { id: "N07-P3-A1", text: "Pre-alert – SDH, warfarin, GCS, herniation signs", maxScore: 2 },
        { id: "N07-P3-A2", text: "פינוי לנוירוכירורגיה דחוף", maxScore: 2 },
        { id: "N07-P3-A3", text: "ניטור serial GCS, pupils", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N08-P1", title: "הערכה ראשונית", actions: [
        { id: "N08-P1-A1", text: "immobilization מוחלט – ידני ועם collar", maxScore: 2 },
        { id: "N08-P1-A2", text: "הערכה נוירולוגית – motor, sensory, level", maxScore: 2 },
        { id: "N08-P1-A3", text: "הכרה על neurogenic shock – BP נמוך + Brady", maxScore: 2 },
        { id: "N08-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "N08-P2", title: "טיפול", actions: [
        { id: "N08-P2-A1", text: "log roll מלא לכל תזוזה", maxScore: 2 },
        { id: "N08-P2-A2", text: "נוזלים IV לneurogenic shock", maxScore: 2 },
        { id: "N08-P2-A3", text: "norepi/atropine אם bradycardia קשה", maxScore: 2 },
        { id: "N08-P2-A4", text: "מניעת היפותרמיה – spinal injury", maxScore: 2 },
      ]},
      { id: "N08-P3", title: "פינוי", actions: [
        { id: "N08-P3-A1", text: "Spinal board + head blocks + collar + straps", maxScore: 2 },
        { id: "N08-P3-A2", text: "Pre-alert – SCI cervical, neurogenic shock, level", maxScore: 2 },
        { id: "N08-P3-A3", text: "פינוי לטראומה עם spinal center", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N09-P1", title: "הערכה ראשונית", actions: [
        { id: "N09-P1-A1", text: "זיהוי classic triad – חום, קשיון עורף, שינוי הכרה", maxScore: 2 },
        { id: "N09-P1-A2", text: "בדיקת פריחה – purpura/petechiae = meningococcemia", maxScore: 2 },
        { id: "N09-P1-A3", text: "Kernig, Brudzinski signs", maxScore: 2 },
        { id: "N09-P1-A4", text: "O2, גישה ורידית, ניטור, בידוד", maxScore: 2 },
      ]},
      { id: "N09-P2", title: "טיפול", actions: [
        { id: "N09-P2-A1", text: "אנטיביוטיקה מיידית – כרבי IM/IV לפני CT", maxScore: 2 },
        { id: "N09-P2-A2", text: "דקסמתזון 0.15mg/kg IV לפני/עם אנטיביוטיקה", maxScore: 2 },
        { id: "N09-P2-A3", text: "נוזלים IV לתמיכה המודינמית", maxScore: 2 },
        { id: "N09-P2-A4", text: "ניטור GCS, pupil", maxScore: 2 },
      ]},
      { id: "N09-P3", title: "פינוי", actions: [
        { id: "N09-P3-A1", text: "Pre-alert – meningitis, purpura, אנטיביוטיקה", maxScore: 2 },
        { id: "N09-P3-A2", text: "פינוי דחוף לICU ואינפקציולוגיה", maxScore: 2 },
        { id: "N09-P3-A3", text: "דיווח בריאות הציבור – מחלה מידברת", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N10-P1", title: "הערכה ראשונית", actions: [
        { id: "N10-P1-A1", text: "Wernicke triad – בלבול, ataxia, ophthalmoplegia", maxScore: 2 },
        { id: "N10-P1-A2", text: "גלוקומטר – גלוקוז לפני thiamine!", maxScore: 2 },
        { id: "N10-P1-A3", text: "אנמנזה – אלכוהול, תת-תזונה, הקאות", maxScore: 2 },
        { id: "N10-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "N10-P2", title: "טיפול", actions: [
        { id: "N10-P2-A1", text: "Thiamine 200mg IV לפני/במקביל גלוקוז!", maxScore: 2 },
        { id: "N10-P2-A2", text: "גלוקוז 50% IV אם היפוגליקמיה – רק אחרי thiamine", maxScore: 2 },
        { id: "N10-P2-A3", text: "נוזלים IV – saline, לא D5W בלי thiamine", maxScore: 2 },
        { id: "N10-P2-A4", text: "ניטור GCS, pupil", maxScore: 2 },
      ]},
      { id: "N10-P3", title: "פינוי", actions: [
        { id: "N10-P3-A1", text: "Pre-alert – Wernicke, אלכוהוליסט, thiamine", maxScore: 2 },
        { id: "N10-P3-A2", text: "פינוי לאינטרניסט/נוירולוגיה", maxScore: 2 },
        { id: "N10-P3-A3", text: "ניטור תגובה לthiamine", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N11-P1", title: "הערכה ראשונית", actions: [
        { id: "N11-P1-A1", text: "הגנת airway – מיקום צד, שאיבה", maxScore: 2 },
        { id: "N11-P1-A2", text: "O2 high-flow, גישה ורידית/IO", maxScore: 2 },
        { id: "N11-P1-A3", text: "גלוקומטר – היפוגליקמיה גורם שכיח", maxScore: 2 },
        { id: "N11-P1-A4", text: "זמן פרכוס – >5 דקות = status", maxScore: 2 },
      ]},
      { id: "N11-P2", title: "טיפול", actions: [
        { id: "N11-P2-A1", text: "בנזודיאזפין: מידזולאם IM/IV או דיאזפם רקטלי", maxScore: 2 },
        { id: "N11-P2-A2", text: "חזרה אם ללא הפסקה ב-5 דקות – מנה שנייה", maxScore: 2 },
        { id: "N11-P2-A3", text: "Phenytoin 20mg/kg IV כ-second line", maxScore: 2 },
        { id: "N11-P2-A4", text: "אינטובציה RSI אם status refractory", maxScore: 2 },
      ]},
      { id: "N11-P3", title: "פינוי", actions: [
        { id: "N11-P3-A1", text: "Pre-alert – status epilepticus, תרופות, זמן", maxScore: 2 },
        { id: "N11-P3-A2", text: "פינוי לICU נוירולוגי", maxScore: 2 },
        { id: "N11-P3-A3", text: "ניטור GCS, פרכוסים, SpO2", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N12-P1", title: "הערכה ראשונית", actions: [
        { id: "N12-P1-A1", text: "AEIOU-TIPS – גורמי AMS", maxScore: 2 },
        { id: "N12-P1-A2", text: "גלוקומטר, SpO2, ECG, טמפרטורה", maxScore: 2 },
        { id: "N12-P1-A3", text: "FAST – שלילת CVA", maxScore: 2 },
        { id: "N12-P1-A4", text: "אנמנזה – תרופות, מחלות, שינויים", maxScore: 2 },
      ]},
      { id: "N12-P2", title: "טיפול", actions: [
        { id: "N12-P2-A1", text: "O2, נוזלים IV אם נמוך לחץ דם/sepsis", maxScore: 2 },
        { id: "N12-P2-A2", text: "גלוקוז אם היפוגליקמי", maxScore: 2 },
        { id: "N12-P2-A3", text: "ניטור ECG – AF/bradycardia", maxScore: 2 },
        { id: "N12-P2-A4", text: "הגנת airway – מניעת אספירציה", maxScore: 2 },
      ]},
      { id: "N12-P3", title: "פינוי", actions: [
        { id: "N12-P3-A1", text: "Pre-alert – AMS, קשיש, ספסיס?, גלוקוז", maxScore: 2 },
        { id: "N12-P3-A2", text: "פינוי לאבחון – CT ראש, תרביות, בדיקות", maxScore: 2 },
        { id: "N12-P3-A3", text: "ניטור GCS ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N13-P1", title: "הערכה ראשונית", actions: [
        { id: "N13-P1-A1", text: "GCS serial, pupil check – unilateral dilation = herniation", maxScore: 2 },
        { id: "N13-P1-A2", text: "Cushing's triad – hypertension, bradycardia, irregular respiration", maxScore: 2 },
        { id: "N13-P1-A3", text: "O2, ניהול airway דחוף", maxScore: 2 },
        { id: "N13-P1-A4", text: "ראש 30° למעלה, midline", maxScore: 2 },
      ]},
      { id: "N13-P2", title: "טיפול", actions: [
        { id: "N13-P2-A1", text: "RSI מיידי – GCS≤8 herniation", maxScore: 2 },
        { id: "N13-P2-A2", text: "Hyperventilation קצר – PaCO2 35, לא <30", maxScore: 2 },
        { id: "N13-P2-A3", text: "מניטול 1g/kg IV bolus", maxScore: 2 },
        { id: "N13-P2-A4", text: "NaCl 3% היפרטוני כאלטרנטיב", maxScore: 2 },
      ]},
      { id: "N13-P3", title: "פינוי", actions: [
        { id: "N13-P3-A1", text: "Pre-alert – brain herniation, GCS, pupils, Cushing's", maxScore: 2 },
        { id: "N13-P3-A2", text: "פינוי דחוף לנוירוכירורגיה", maxScore: 2 },
        { id: "N13-P3-A3", text: "ניטור EtCO2 בנסיעה – hyperventilation מבוקר", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N14-P1", title: "הערכה ראשונית", actions: [
        { id: "N14-P1-A1", text: "גלוקומטר מיידי – ALWAYS בAMS", maxScore: 2 },
        { id: "N14-P1-A2", text: "FAST – חולשה חד-צדדית: CVA vs hypoglycemia", maxScore: 2 },
        { id: "N14-P1-A3", text: "אנמנזה – אינסולין, אוכל, מחלה", maxScore: 2 },
        { id: "N14-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "N14-P2", title: "טיפול", actions: [
        { id: "N14-P2-A1", text: "גלוקוז 50% 50ml IV מיידי", maxScore: 2 },
        { id: "N14-P2-A2", text: "גלוקגון 1mg IM אם ללא גישה ורידית", maxScore: 2 },
        { id: "N14-P2-A3", text: "ניטור גלוקוז חוזר כל 15 דקות", maxScore: 2 },
        { id: "N14-P2-A4", text: "אוכל/שתיה לאחר השכלת הכרה", maxScore: 2 },
      ]},
      { id: "N14-P3", title: "פינוי", actions: [
        { id: "N14-P3-A1", text: "פינוי גם לאחר שיפור – תסמינים נוירולוגיים זקוקים לCT", maxScore: 2 },
        { id: "N14-P3-A2", text: "Pre-alert – hypoglycemia + neurological deficit, CT", maxScore: 2 },
        { id: "N14-P3-A3", text: "ניטור גלוקוז ו-FAST בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N15-P1", title: "הערכה ראשונית", actions: [
        { id: "N15-P1-A1", text: "שלילת thunder clap headache – SAH", maxScore: 2 },
        { id: "N15-P1-A2", text: "FAST – שלילת CVA", maxScore: 2 },
        { id: "N15-P1-A3", text: "אנמנזה – מיגרנה ידועה, אאורה, תרופות", maxScore: 2 },
        { id: "N15-P1-A4", text: "גלוקומטר, ניטור, O2 אם נדרש", maxScore: 2 },
      ]},
      { id: "N15-P2", title: "טיפול", actions: [
        { id: "N15-P2-A1", text: "חדר חשוך ושקט, הפחתת גירויים", maxScore: 2 },
        { id: "N15-P2-A2", text: "מטוקלופרמיד 10mg IV – antiemetic + antimigraine", maxScore: 2 },
        { id: "N15-P2-A3", text: "פרוקטול/נפרוקסן IV אנלגזיה", maxScore: 2 },
        { id: "N15-P2-A4", text: "נוזלים IV – התייבשות שכיחה", maxScore: 2 },
      ]},
      { id: "N15-P3", title: "פינוי", actions: [
        { id: "N15-P3-A1", text: "פינוי לשלילת SAH אם thunder clap או ראשונה", maxScore: 2 },
        { id: "N15-P3-A2", text: "Pre-alert – מיגרנה vs SAH, FAST", maxScore: 2 },
        { id: "N15-P3-A3", text: "ניטור GCS, הופעת סימנים נוירולוגיים חדשים", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N16-P1", title: "הערכה ראשונית", actions: [
        { id: "N16-P1-A1", text: "FAST – הבחנה central vs peripheral facial palsy", maxScore: 2 },
        { id: "N16-P1-A2", text: "בדיקת מצח – חולשת מצח = peripheral (Bell's)", maxScore: 2 },
        { id: "N16-P1-A3", text: "שלילת תסמינים נוספים – CVA multi-system", maxScore: 2 },
        { id: "N16-P1-A4", text: "גלוקומטר, ניטור", maxScore: 2 },
      ]},
      { id: "N16-P2", title: "טיפול", actions: [
        { id: "N16-P2-A1", text: "הרגעת חולה – Bell's לא מסכן חיים", maxScore: 2 },
        { id: "N16-P2-A2", text: "הגנת עין – eye drops, לא לעצום עין מלא", maxScore: 2 },
        { id: "N16-P2-A3", text: "לא lytics – Bell's peripheral", maxScore: 2 },
        { id: "N16-P2-A4", text: "אם אי-ודאות – פינוי כ-CVA", maxScore: 2 },
      ]},
      { id: "N16-P3", title: "פינוי", actions: [
        { id: "N16-P3-A1", text: "פינוי לCT ושלילת CVA/מסה", maxScore: 2 },
        { id: "N16-P3-A2", text: "Pre-alert – facial palsy, peripheral?, CT", maxScore: 2 },
        { id: "N16-P3-A3", text: "ניטור לסימנים נוירולוגיים נוספים", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N17-P1", title: "הערכה ראשונית", actions: [
        { id: "N17-P1-A1", text: "אנמנזה מפורטת – לפני, במהלך, אחרי", maxScore: 2 },
        { id: "N17-P1-A2", text: "ECG – ריתמי, QT, WPW, HCM", maxScore: 2 },
        { id: "N17-P1-A3", text: "גלוקומטר, BP שכיבה/ישיבה – orthostatic", maxScore: 2 },
        { id: "N17-P1-A4", text: "FAST – שלילת נוירולוגי", maxScore: 2 },
      ]},
      { id: "N17-P2", title: "טיפול", actions: [
        { id: "N17-P2-A1", text: "אם ואגאלי – מיקום supine, רגליים מורמות", maxScore: 2 },
        { id: "N17-P2-A2", text: "נוזלים IV אם orthostatic/dehydration", maxScore: 2 },
        { id: "N17-P2-A3", text: "ריתמי ECG – אם cardiac cause", maxScore: 2 },
        { id: "N17-P2-A4", text: "O2, ניטור", maxScore: 2 },
      ]},
      { id: "N17-P3", title: "פינוי", actions: [
        { id: "N17-P3-A1", text: "כאב חזה לפני סינקופה = cardiac = פינוי חובה", maxScore: 2 },
        { id: "N17-P3-A2", text: "Pre-alert – syncope + chest pain, ECG, risky features", maxScore: 2 },
        { id: "N17-P3-A3", text: "ניטור ECG ברציפות בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "N18-P1", title: "הערכה ראשונית", actions: [
        { id: "N18-P1-A1", text: "זיהוי thunder clap headache – SAH עד שלא הוכח אחרת", maxScore: 2 },
        { id: "N18-P1-A2", text: "FAST, GCS, pupil check", maxScore: 2 },
        { id: "N18-P1-A3", text: "גלוקומטר, BP, ניטור", maxScore: 2 },
        { id: "N18-P1-A4", text: "O2, גישה ורידית", maxScore: 2 },
      ]},
      { id: "N18-P2", title: "טיפול", actions: [
        { id: "N18-P2-A1", text: "BP control זהיר – מטרה <160 systolic", maxScore: 2 },
        { id: "N18-P2-A2", text: "הגנת airway – GCS, aspiration risk", maxScore: 2 },
        { id: "N18-P2-A3", text: "לא lytics – דימום!", maxScore: 2 },
        { id: "N18-P2-A4", text: "אנלגזיה זהיר – לא מדכא הכרה", maxScore: 2 },
      ]},
      { id: "N18-P3", title: "פינוי", actions: [
        { id: "N18-P3-A1", text: "Pre-alert – thunder clap, SAH, BP, GCS", maxScore: 2 },
        { id: "N18-P3-A2", text: "פינוי לCT + LP + נוירוכירורגיה", maxScore: 2 },
        { id: "N18-P3-A3", text: "ניטור serial GCS, BP ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T06-P1", title: "הערכה ראשונית", actions: [
        { id: "T06-P1-A1", text: "MARCH – Massive hemorrhage, airway, breathing", maxScore: 2 },
        { id: "T06-P1-A2", text: "חבישת פצע חודר – occlusive dressing 3 צדדים", maxScore: 2 },
        { id: "T06-P1-A3", text: "האזנה – פנאומוטורקס מתח? טמפונדה?", maxScore: 2 },
        { id: "T06-P1-A4", text: "O2 high-flow, גישה ורידית x2", maxScore: 2 },
      ]},
      { id: "T06-P2", title: "טיפול", actions: [
        { id: "T06-P2-A1", text: "פנאומוטורקס מתח – ניקוב מחט מיידי", maxScore: 2 },
        { id: "T06-P2-A2", text: "טמפונדה – נוזלים, פינוי מיידי לניתוח", maxScore: 2 },
        { id: "T06-P2-A3", text: "נוזלים IV permissive hypotension – BP≥90 systolic", maxScore: 2 },
        { id: "T06-P2-A4", text: "חימום, מניעת coagulopathy", maxScore: 2 },
      ]},
      { id: "T06-P3", title: "פינוי", actions: [
        { id: "T06-P3-A1", text: "Pre-alert – penetrating chest, BP, טמפונדה/PTX", maxScore: 2 },
        { id: "T06-P3-A2", text: "פינוי מהיר לחדר ניתוח", maxScore: 2 },
        { id: "T06-P3-A3", text: "ניטור ברציפות, מוכנות לCPR", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T07-P1", title: "הערכה ראשונית", actions: [
        { id: "T07-P1-A1", text: "MARCH – trauma primary survey", maxScore: 2 },
        { id: "T07-P1-A2", text: "כיסוי מעיים – חבישה לחה ולא להחזיר!", maxScore: 2 },
        { id: "T07-P1-A3", text: "O2, גישה ורידית x2", maxScore: 2 },
        { id: "T07-P1-A4", text: "הערכת נפח איבוד דם", maxScore: 2 },
      ]},
      { id: "T07-P2", title: "טיפול", actions: [
        { id: "T07-P2-A1", text: "חבישה לחה מלוחה (saline) על המעיים", maxScore: 2 },
        { id: "T07-P2-A2", text: "נוזלים IV permissive hypotension", maxScore: 2 },
        { id: "T07-P2-A3", text: "אנלגזיה IV – מורפין/קטמין", maxScore: 2 },
        { id: "T07-P2-A4", text: "מניעת היפותרמיה", maxScore: 2 },
      ]},
      { id: "T07-P3", title: "פינוי", actions: [
        { id: "T07-P3-A1", text: "Pre-alert – evisceration, BP, ניתוח דחוף", maxScore: 2 },
        { id: "T07-P3-A2", text: "פינוי מהיר לחדר ניתוח", maxScore: 2 },
        { id: "T07-P3-A3", text: "ניטור BP, SpO2 ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T08-P1", title: "הערכה ראשונית", actions: [
        { id: "T08-P1-A1", text: "ABCDE + trauma survey, C-spine immobilization", maxScore: 2 },
        { id: "T08-P1-A2", text: "GCS, pupil check, Cushing's response", maxScore: 2 },
        { id: "T08-P1-A3", text: "O2 high-flow, SPO2 מטרה >95%", maxScore: 2 },
        { id: "T08-P1-A4", text: "BP מטרה >90 systolic – מוח צריך CPP", maxScore: 2 },
      ]},
      { id: "T08-P2", title: "טיפול", actions: [
        { id: "T08-P2-A1", text: "RSI מיידי – GCS≤8", maxScore: 2 },
        { id: "T08-P2-A2", text: "EtCO2 מטרה 35-45 – לא hyperventilate", maxScore: 2 },
        { id: "T08-P2-A3", text: "מניטול 1g/kg IV אם herniation signs", maxScore: 2 },
        { id: "T08-P2-A4", text: "ראש 30°, midline, לא PEEP גבוה", maxScore: 2 },
      ]},
      { id: "T08-P3", title: "פינוי", actions: [
        { id: "T08-P3-A1", text: "Pre-alert – severe TBI, GCS, pupils, RSI", maxScore: 2 },
        { id: "T08-P3-A2", text: "פינוי לנוירוכירורגיה CT מיידי", maxScore: 2 },
        { id: "T08-P3-A3", text: "ניטור EtCO2, BP, GCS בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T09-P1", title: "הערכה ראשונית", actions: [
        { id: "T09-P1-A1", text: "הערכת איברים – perfusion, sensation, motion", maxScore: 2 },
        { id: "T09-P1-A2", text: "גישה ורידית x2 לפני שחרור הריסוק", maxScore: 2 },
        { id: "T09-P1-A3", text: "ECG – היפרקלמיה (peaked T, wide QRS)", maxScore: 2 },
        { id: "T09-P1-A4", text: "ניטור BP, SpO2", maxScore: 2 },
      ]},
      { id: "T09-P2", title: "טיפול", actions: [
        { id: "T09-P2-A1", text: "נוזלים IV מאסיביים לפני שחרור – rhabdo flush", maxScore: 2 },
        { id: "T09-P2-A2", text: "נתרן ביקרבונאט – אלקליזציה שתן", maxScore: 2 },
        { id: "T09-P2-A3", text: "היפרקלמיה – גלוקונאט סידן IV", maxScore: 2 },
        { id: "T09-P2-A4", text: "חוסם עורקים לפני שחרור אם necessary", maxScore: 2 },
      ]},
      { id: "T09-P3", title: "פינוי", actions: [
        { id: "T09-P3-A1", text: "Pre-alert – crush, rhabdomyolysis, hyperkalemia, ECG", maxScore: 2 },
        { id: "T09-P3-A2", text: "פינוי לICU/כירורגיה – dialysis risk", maxScore: 2 },
        { id: "T09-P3-A3", text: "ניטור ECG ברציפות – היפרקלמיה arrythmia", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T10-P1", title: "הערכה ראשונית", actions: [
        { id: "T10-P1-A1", text: "Blast injury 4 patterns – primary, secondary, tertiary, quaternary", maxScore: 2 },
        { id: "T10-P1-A2", text: "הערכת ריאות – blast lung", maxScore: 2 },
        { id: "T10-P1-A3", text: "הערכת TM, אוזניים, abdomen, extremities", maxScore: 2 },
        { id: "T10-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "T10-P2", title: "טיפול", actions: [
        { id: "T10-P2-A1", text: "O2 high-flow – blast lung/pneumothorax", maxScore: 2 },
        { id: "T10-P2-A2", text: "שמיעה ו-TM damage – documentation", maxScore: 2 },
        { id: "T10-P2-A3", text: "נוזלים זהיר – blast lung = ARDS risk", maxScore: 2 },
        { id: "T10-P2-A4", text: "פנאומוטורקס – ניקוב מחט אם tension signs", maxScore: 2 },
      ]},
      { id: "T10-P3", title: "פינוי", actions: [
        { id: "T10-P3-A1", text: "Pre-alert – blast injury, ריאות, SpO2, brain", maxScore: 2 },
        { id: "T10-P3-A2", text: "פינוי לטראומה – CT מלא", maxScore: 2 },
        { id: "T10-P3-A3", text: "ניטור SpO2, BP, GCS בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T11-P1", title: "הערכה ראשונית", actions: [
        { id: "T11-P1-A1", text: "MARCH – Massive hemorrhage control", maxScore: 2 },
        { id: "T11-P1-A2", text: "C-spine immobilization, log roll", maxScore: 2 },
        { id: "T11-P1-A3", text: "Primary survey – ABCDE", maxScore: 2 },
        { id: "T11-P1-A4", text: "FAST – free fluid בטן, pericardial", maxScore: 2 },
      ]},
      { id: "T11-P2", title: "טיפול", actions: [
        { id: "T11-P2-A1", text: "RSI – GCS ירוד, airway protection", maxScore: 2 },
        { id: "T11-P2-A2", text: "נוזלים IV permissive hypotension", maxScore: 2 },
        { id: "T11-P2-A3", text: "hemothorax – ניקוב מחט PTX? צינור חזה בBH", maxScore: 2 },
        { id: "T11-P2-A4", text: "חימום, חוסם עורקים לפציעות גפיים", maxScore: 2 },
      ]},
      { id: "T11-P3", title: "פינוי", actions: [
        { id: "T11-P3-A1", text: "Pre-alert – polytrauma, GCS, BP, FAST positive", maxScore: 2 },
        { id: "T11-P3-A2", text: "פינוי לחדר טראומה – מוכן לניתוח", maxScore: 2 },
        { id: "T11-P3-A3", text: "ניטור ברציפות, תיעוד mechanism", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T12-P1", title: "הערכה ראשונית", actions: [
        { id: "T12-P1-A1", text: "חוסם עורקים מיידי מעל הקטיעה", maxScore: 2 },
        { id: "T12-P1-A2", text: "זמן הנחת חוסם עורקים – תיעוד!", maxScore: 2 },
        { id: "T12-P1-A3", text: "O2, גישה ורידית x2, ניטור", maxScore: 2 },
        { id: "T12-P1-A4", text: "שמירת הגפה הקטועה – קר ולח, לא קפוא", maxScore: 2 },
      ]},
      { id: "T12-P2", title: "טיפול", actions: [
        { id: "T12-P2-A1", text: "נוזלים IV aggressive – hemorrhagic shock", maxScore: 2 },
        { id: "T12-P2-A2", text: "חבישה לחיץ על גדם", maxScore: 2 },
        { id: "T12-P2-A3", text: "אנלגזיה IV – קטמין/מורפין", maxScore: 2 },
        { id: "T12-P2-A4", text: "גפה קטועה בשקית פלסטיק + קרח עטוף", maxScore: 2 },
      ]},
      { id: "T12-P3", title: "פינוי", actions: [
        { id: "T12-P3-A1", text: "Pre-alert – traumatic amputation, זמן, גפה שמורה", maxScore: 2 },
        { id: "T12-P3-A2", text: "פינוי לכירורגיה עם מרכז replantation", maxScore: 2 },
        { id: "T12-P3-A3", text: "ניטור BP, פינוי מהיר – golden hour", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T13-P1", title: "הערכה ראשונית", actions: [
        { id: "T13-P1-A1", text: "הערכת airway – stridor, ריסים שרופים", maxScore: 2 },
        { id: "T13-P1-A2", text: "O2 100% NRB – CO poisoning", maxScore: 2 },
        { id: "T13-P1-A3", text: "חישוב TBSA – rule of 9s", maxScore: 2 },
        { id: "T13-P1-A4", text: "גישה ורידית x2, ניטור", maxScore: 2 },
      ]},
      { id: "T13-P2", title: "טיפול", actions: [
        { id: "T13-P2-A1", text: "RSI מוקדם – inhalation injury airway", maxScore: 2 },
        { id: "T13-P2-A2", text: "Parkland formula – 4ml/kg/% TBSA ב-24h", maxScore: 2 },
        { id: "T13-P2-A3", text: "חבישה יבשה קרה – לא קרח", maxScore: 2 },
        { id: "T13-P2-A4", text: "אנלגזיה IV – קטמין/מורפין", maxScore: 2 },
      ]},
      { id: "T13-P3", title: "פינוי", actions: [
        { id: "T13-P3-A1", text: "Pre-alert – כוויות TBSA%, airway, CO, אינטובציה", maxScore: 2 },
        { id: "T13-P3-A2", text: "פינוי למרכז כוויות", maxScore: 2 },
        { id: "T13-P3-A3", text: "ניטור SpO2, BP, urine output הערכה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T14-P1", title: "הערכה ראשונית", actions: [
        { id: "T14-P1-A1", text: "Spinal immobilization – collar, backboard", maxScore: 2 },
        { id: "T14-P1-A2", text: "הערכה נוירולוגית – motor, sensory, reflexes", maxScore: 2 },
        { id: "T14-P1-A3", text: "Cauda equina – saddle anesthesia, bladder/bowel", maxScore: 2 },
        { id: "T14-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "T14-P2", title: "טיפול", actions: [
        { id: "T14-P2-A1", text: "log roll בכל תזוזה", maxScore: 2 },
        { id: "T14-P2-A2", text: "נוזלים IV – neurogenic shock?", maxScore: 2 },
        { id: "T14-P2-A3", text: "אנלגזיה זהיר – לא מסיר assessment", maxScore: 2 },
        { id: "T14-P2-A4", text: "מניעת היפותרמיה", maxScore: 2 },
      ]},
      { id: "T14-P3", title: "פינוי", actions: [
        { id: "T14-P3-A1", text: "Pre-alert – SCI, cauda equina, level, neurologic", maxScore: 2 },
        { id: "T14-P3-A2", text: "פינוי לנוירוכירורגיה – cauda equina emergency", maxScore: 2 },
        { id: "T14-P3-A3", text: "תיעוד נוירולוגי serial", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T15-P1", title: "הערכה ראשונית", actions: [
        { id: "T15-P1-A1", text: "MARCH – דימום פנימי, לא מוציאים גוף זר", maxScore: 2 },
        { id: "T15-P1-A2", text: "FAST – free fluid", maxScore: 2 },
        { id: "T15-P1-A3", text: "O2, גישה ורידית x2", maxScore: 2 },
        { id: "T15-P1-A4", text: "מניין פצעי כניסה/יציאה", maxScore: 2 },
      ]},
      { id: "T15-P2", title: "טיפול", actions: [
        { id: "T15-P2-A1", text: "חבישה סטרילית על פצעים – לא לחץ חזק", maxScore: 2 },
        { id: "T15-P2-A2", text: "נוזלים permissive hypotension", maxScore: 2 },
        { id: "T15-P2-A3", text: "TXA 1g IV תוך שעה מהאירוע", maxScore: 2 },
        { id: "T15-P2-A4", text: "חימום, מניעת coagulopathy", maxScore: 2 },
      ]},
      { id: "T15-P3", title: "פינוי", actions: [
        { id: "T15-P3-A1", text: "Pre-alert – GSW abdomen, BP, FAST, TXA", maxScore: 2 },
        { id: "T15-P3-A2", text: "פינוי מהיר לניתוח – damage control", maxScore: 2 },
        { id: "T15-P3-A3", text: "ניטור BP, SpO2, mentation", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T16-P1", title: "הערכה ראשונית", actions: [
        { id: "T16-P1-A1", text: "C-spine immobilization, ABCDE", maxScore: 2 },
        { id: "T16-P1-A2", text: "GCS serial, pupil check", maxScore: 2 },
        { id: "T16-P1-A3", text: "אנמנזה – warfarin, מינון, INR", maxScore: 2 },
        { id: "T16-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "T16-P2", title: "טיפול", actions: [
        { id: "T16-P2-A1", text: "ניהול airway – RSI אם GCS ירד", maxScore: 2 },
        { id: "T16-P2-A2", text: "Vitamin K IV, PCC – warfarin reversal בשדה", maxScore: 2 },
        { id: "T16-P2-A3", text: "אנלגזיה זהיר – לא NSAIDs", maxScore: 2 },
        { id: "T16-P2-A4", text: "ניטור GCS ברציפות – הידרדרות = SDH", maxScore: 2 },
      ]},
      { id: "T16-P3", title: "פינוי", actions: [
        { id: "T16-P3-A1", text: "Pre-alert – head trauma, warfarin, GCS, SDH risk", maxScore: 2 },
        { id: "T16-P3-A2", text: "פינוי לCT ראש ונוירוכירורגיה", maxScore: 2 },
        { id: "T16-P3-A3", text: "ניטור GCS, צלעות, SpO2", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T17-P1", title: "הערכה ראשונית", actions: [
        { id: "T17-P1-A1", text: "ABCDE ילד – וזן גיל, BP נורמלי", maxScore: 2 },
        { id: "T17-P1-A2", text: "FAST – hemoperitoneum", maxScore: 2 },
        { id: "T17-P1-A3", text: "גישה ורידית/IO, O2", maxScore: 2 },
        { id: "T17-P1-A4", text: "משקל ילד לחישוב נוזלים ותרופות", maxScore: 2 },
      ]},
      { id: "T17-P2", title: "טיפול", actions: [
        { id: "T17-P2-A1", text: "נוזלים 20ml/kg bolus IV/IO", maxScore: 2 },
        { id: "T17-P2-A2", text: "אנלגזיה ילדים – קטמין/מורפין במינון ילד", maxScore: 2 },
        { id: "T17-P2-A3", text: "TXA – >16kg כ-15mg/kg IV", maxScore: 2 },
        { id: "T17-P2-A4", text: "חימום, מניעת היפותרמיה", maxScore: 2 },
      ]},
      { id: "T17-P3", title: "פינוי", actions: [
        { id: "T17-P3-A1", text: "Pre-alert – pediatric trauma, hemoperitoneum, BP", maxScore: 2 },
        { id: "T17-P3-A2", text: "פינוי לחדר ניתוח ילדים", maxScore: 2 },
        { id: "T17-P3-A3", text: "ניטור BP, GCS, SpO2", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T18-P1", title: "הערכה ראשונית", actions: [
        { id: "T18-P1-A1", text: "מדידת טמפרטורה תיקנית – rectal/esophageal", maxScore: 2 },
        { id: "T18-P1-A2", text: "ECG – J waves (Osborn waves), ריתמי", maxScore: 2 },
        { id: "T18-P1-A3", text: "לא הכרזת מוות – 'not dead until warm and dead'", maxScore: 2 },
        { id: "T18-P1-A4", text: "O2 חמים לחים, גישה ורידית", maxScore: 2 },
      ]},
      { id: "T18-P2", title: "טיפול", actions: [
        { id: "T18-P2-A1", text: "חימום פסיבי – בגדים רטובים, שמיכות", maxScore: 2 },
        { id: "T18-P2-A2", text: "נוזלים חמים IV 40°C", maxScore: 2 },
        { id: "T18-P2-A3", text: "CPR אם VF/PEA – AED אחרי חימום", maxScore: 2 },
        { id: "T18-P2-A4", text: "הימנע מתנועות חדות – arrhythmia", maxScore: 2 },
      ]},
      { id: "T18-P3", title: "פינוי", actions: [
        { id: "T18-P3-A1", text: "Pre-alert – severe hypothermia, ECMO warming center", maxScore: 2 },
        { id: "T18-P3-A2", text: "פינוי למרכז עם ECMO/rewarming", maxScore: 2 },
        { id: "T18-P3-A3", text: "ניטור טמפרטורה ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T19-P1", title: "הערכה ראשונית", actions: [
        { id: "T19-P1-A1", text: "Tension pneumothorax – tracheal deviation, absent breath sounds", maxScore: 2 },
        { id: "T19-P1-A2", text: "ניקוב מחט מיידי – 2nd ICS MCL", maxScore: 2 },
        { id: "T19-P1-A3", text: "O2 high-flow, גישה ורידית", maxScore: 2 },
        { id: "T19-P1-A4", text: "occlusive dressing על פצע – 3 צדדים", maxScore: 2 },
      ]},
      { id: "T19-P2", title: "טיפול", actions: [
        { id: "T19-P2-A1", text: "ניקוב מחט עם אישור – השמעת אוויר", maxScore: 2 },
        { id: "T19-P2-A2", text: "נוזלים IV permissive hypotension", maxScore: 2 },
        { id: "T19-P2-A3", text: "הכנה לצינור חזה בבית חולים", maxScore: 2 },
        { id: "T19-P2-A4", text: "ניטור תגובה – SpO2, BP, mentation", maxScore: 2 },
      ]},
      { id: "T19-P3", title: "פינוי", actions: [
        { id: "T19-P3-A1", text: "Pre-alert – tension PTX, ניקוב, SpO2", maxScore: 2 },
        { id: "T19-P3-A2", text: "פינוי לכירורגיה – chest tube", maxScore: 2 },
        { id: "T19-P3-A3", text: "ניטור ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "T20-P1", title: "הערכה ראשונית", actions: [
        { id: "T20-P1-A1", text: "C-spine immobilization – trauma mechanism", maxScore: 2 },
        { id: "T20-P1-A2", text: "GCS, pupil check, ABCDE", maxScore: 2 },
        { id: "T20-P1-A3", text: "מדידת טמפרטורה, ECG", maxScore: 2 },
        { id: "T20-P1-A4", text: "O2, גישה ורידית/IO", maxScore: 2 },
      ]},
      { id: "T20-P2", title: "טיפול", actions: [
        { id: "T20-P2-A1", text: "ניהול airway – RSI עם C-spine precautions", maxScore: 2 },
        { id: "T20-P2-A2", text: "נוזלים חמים IV", maxScore: 2 },
        { id: "T20-P2-A3", text: "לא הכרזת מוות – היפותרמיה", maxScore: 2 },
        { id: "T20-P2-A4", text: "CPR אם נדרש", maxScore: 2 },
      ]},
      { id: "T20-P3", title: "פינוי", actions: [
        { id: "T20-P3-A1", text: "Pre-alert – drowning trauma, hypothermia, GCS, RSI", maxScore: 2 },
        { id: "T20-P3-A2", text: "פינוי לטראומה עם יכולת rewarming", maxScore: 2 },
        { id: "T20-P3-A3", text: "ניטור טמפרטורה, SpO2, GCS", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P04-P1", title: "הערכה ראשונית", actions: [
        { id: "P04-P1-A1", text: "ייבוש וגירוי, שמירת חום", maxScore: 2 },
        { id: "P04-P1-A2", text: "הערכת נשימה ודופק – 60 שניות", maxScore: 2 },
        { id: "P04-P1-A3", text: "פתיחת נתיב אוויר – sniffing position", maxScore: 2 },
        { id: "P04-P1-A4", text: "Apgar score – 1 ו-5 דקות", maxScore: 2 },
      ]},
      { id: "P04-P2", title: "טיפול", actions: [
        { id: "P04-P2-A1", text: "PPV – BVM 40-60 נשימות/דקה, מסכה מתאימה", maxScore: 2 },
        { id: "P04-P2-A2", text: "אם דופק <60 – לחיצות חזה 3:1", maxScore: 2 },
        { id: "P04-P2-A3", text: "אינטובציה אם PPV לא יעיל", maxScore: 2 },
        { id: "P04-P2-A4", text: "אדרנלין IO/IV 0.01mg/kg אם דופק <60 לאחר לחיצות", maxScore: 2 },
        { id: "P04-P2-A5", text: "גלוקוז – בדיקה וטיפול", maxScore: 2 },
      ]},
      { id: "P04-P3", title: "פינוי", actions: [
        { id: "P04-P3-A1", text: "Pre-alert – neonatal resus, גיל הריון, Apgar, טיפול", maxScore: 2 },
        { id: "P04-P3-A2", text: "פינוי לNICU עם חימום", maxScore: 2 },
        { id: "P04-P3-A3", text: "ניטור ברציפות – SpO2, دل, גלוקוז", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P05-P1", title: "הערכה ראשונית", actions: [
        { id: "P05-P1-A1", text: "בטיחות – מניעת פציעה בזמן פרכוס", maxScore: 2 },
        { id: "P05-P1-A2", text: "זמן פרכוס, אופי, גיל, חום", maxScore: 2 },
        { id: "P05-P1-A3", text: "ABCDE לאחר פרכוס – post-ictal assessment", maxScore: 2 },
        { id: "P05-P1-A4", text: "גלוקומטר, טמפרטורה, ניטור", maxScore: 2 },
      ]},
      { id: "P05-P2", title: "טיפול", actions: [
        { id: "P05-P2-A1", text: "אם פרכוס נמשך >5 דקות – מידזולאם IM/intranasal", maxScore: 2 },
        { id: "P05-P2-A2", text: "הורדת חום – פרצטמול/איבופרופן", maxScore: 2 },
        { id: "P05-P2-A3", text: "O2 אם SpO2 ירוד", maxScore: 2 },
        { id: "P05-P2-A4", text: "הרגעת הורים – febrile seizure בדרך כלל שפיר", maxScore: 2 },
      ]},
      { id: "P05-P3", title: "פינוי", actions: [
        { id: "P05-P3-A1", text: "פינוי לכל פרכוס חום ראשון לאבחון", maxScore: 2 },
        { id: "P05-P3-A2", text: "Pre-alert – febrile seizure, גיל, חום, משך", maxScore: 2 },
        { id: "P05-P3-A3", text: "ניטור לפרכוס חוזר, GCS", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P06-P1", title: "הערכה ראשונית", actions: [
        { id: "P06-P1-A1", text: "הערכת מאמץ נשימתי – nasal flaring, retractions", maxScore: 2 },
        { id: "P06-P1-A2", text: "O2 high-flow nasal cannula", maxScore: 2 },
        { id: "P06-P1-A3", text: "מינימום גירויים – תינוק מתגרה בקלות", maxScore: 2 },
        { id: "P06-P1-A4", text: "ניטור SpO2, HR, RR", maxScore: 2 },
      ]},
      { id: "P06-P2", title: "טיפול", actions: [
        { id: "P06-P2-A1", text: "O2 לפי SpO2 – מטרה >94%", maxScore: 2 },
        { id: "P06-P2-A2", text: "שאיבת אף עדינה", maxScore: 2 },
        { id: "P06-P2-A3", text: "High flow O2 nasal cannula – HFNC אם זמין", maxScore: 2 },
        { id: "P06-P2-A4", text: "שלילת ברונכיוליטיס RSV – ניהול תסמיני", maxScore: 2 },
      ]},
      { id: "P06-P3", title: "פינוי", actions: [
        { id: "P06-P3-A1", text: "Pre-alert – bronchiolitis, גיל, SpO2, HFNC", maxScore: 2 },
        { id: "P06-P3-A2", text: "פינוי לאשפוז – ניטור", maxScore: 2 },
        { id: "P06-P3-A3", text: "ניטור SpO2, HR ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P07-P1", title: "הערכה ראשונית", actions: [
        { id: "P07-P1-A1", text: "הרגעת ילד – distress מחמיר stridor", maxScore: 2 },
        { id: "P07-P1-A2", text: "O2 humidified blow-by", maxScore: 2 },
        { id: "P07-P1-A3", text: "Westley score – חומרת קרופ", maxScore: 2 },
        { id: "P07-P1-A4", text: "גישה ורידית – אם ניתן ללא distress", maxScore: 2 },
      ]},
      { id: "P07-P2", title: "טיפול", actions: [
        { id: "P07-P2-A1", text: "אדרנלין nebulizer 5ml (1:1000)", maxScore: 2 },
        { id: "P07-P2-A2", text: "דקסמתזון 0.6mg/kg IM/PO", maxScore: 2 },
        { id: "P07-P2-A3", text: "הכנה לאינטובציה – SpO2<90%", maxScore: 2 },
        { id: "P07-P2-A4", text: "Heliox אם זמין – הפחתת עבודת נשימה", maxScore: 2 },
      ]},
      { id: "P07-P3", title: "פינוי", actions: [
        { id: "P07-P3-A1", text: "Pre-alert – croup severe, גיל, SpO2, אדרנלין", maxScore: 2 },
        { id: "P07-P3-A2", text: "פינוי לאשפוז – rebound אדרנלין", maxScore: 2 },
        { id: "P07-P3-A3", text: "ניטור stridor, SpO2, GCS", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P08-P1", title: "הערכה ראשונית", actions: [
        { id: "P08-P1-A1", text: "קירור כוויה – מים פושרים 20 דקות", maxScore: 2 },
        { id: "P08-P1-A2", text: "TBSA ילד – Lund and Browder chart", maxScore: 2 },
        { id: "P08-P1-A3", text: "הערכת airway – שאיפה?", maxScore: 2 },
        { id: "P08-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "P08-P2", title: "טיפול", actions: [
        { id: "P08-P2-A1", text: "Parkland ילד – 3ml/kg/% TBSA ב-24h", maxScore: 2 },
        { id: "P08-P2-A2", text: "אנלגזיה – קטמין IV/IM, מינון ילד", maxScore: 2 },
        { id: "P08-P2-A3", text: "חבישה יבשה לחה – לא קרח", maxScore: 2 },
        { id: "P08-P2-A4", text: "מניעת היפותרמיה – ילדים מאבדים חום מהר", maxScore: 2 },
      ]},
      { id: "P08-P3", title: "פינוי", actions: [
        { id: "P08-P3-A1", text: "Pre-alert – pediatric burns, TBSA%, גיל, airway", maxScore: 2 },
        { id: "P08-P3-A2", text: "פינוי למרכז כוויות ילדים", maxScore: 2 },
        { id: "P08-P3-A3", text: "ניטור SpO2, BP, תגובה לנוזלים", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P09-P1", title: "הערכה ראשונית", actions: [
        { id: "P09-P1-A1", text: "הערכה רפואית מלאה – פציעות גלויות ונסתרות", maxScore: 2 },
        { id: "P09-P1-A2", text: "זיהוי סימני NAI – bruises multiple ages, burns, שברים", maxScore: 2 },
        { id: "P09-P1-A3", text: "ABCDE – stable? unstable?", maxScore: 2 },
        { id: "P09-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "P09-P2", title: "טיפול", actions: [
        { id: "P09-P2-A1", text: "טיפול פציעות כשגרה", maxScore: 2 },
        { id: "P09-P2-A2", text: "תיעוד מפורט – אנמנזה, פציעות, timeline", maxScore: 2 },
        { id: "P09-P2-A3", text: "לא להאשים – רישום עובדות בלבד", maxScore: 2 },
        { id: "P09-P2-A4", text: "הבטחת בטיחות ילד", maxScore: 2 },
      ]},
      { id: "P09-P3", title: "פינוי", actions: [
        { id: "P09-P3-A1", text: "פינוי לחדר ילדים + Pre-alert חשד NAI", maxScore: 2 },
        { id: "P09-P3-A2", text: "דיווח לרשויות – חוקי רנדל", maxScore: 2 },
        { id: "P09-P3-A3", text: "לא להשאיר ילד עם החשוד", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P10-P1", title: "הערכה ראשונית", actions: [
        { id: "P10-P1-A1", text: "אנמנזה – colicky pain, current jelly stool", maxScore: 2 },
        { id: "P10-P1-A2", text: "בדיקת בטן – sausage mass ב-RUQ", maxScore: 2 },
        { id: "P10-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "P10-P1-A4", text: "FAST – שלילת free fluid", maxScore: 2 },
      ]},
      { id: "P10-P2", title: "טיפול", actions: [
        { id: "P10-P2-A1", text: "נוזלים IV 20ml/kg בנסיעה", maxScore: 2 },
        { id: "P10-P2-A2", text: "אנלגזיה – מורפין מינון ילד", maxScore: 2 },
        { id: "P10-P2-A3", text: "NPO – כירורגיה/enema", maxScore: 2 },
        { id: "P10-P2-A4", text: "ניטור פרפוזיה, mentation", maxScore: 2 },
      ]},
      { id: "P10-P3", title: "פינוי", actions: [
        { id: "P10-P3-A1", text: "Pre-alert – intussusception, גיל, current jelly, כירורגיה", maxScore: 2 },
        { id: "P10-P3-A2", text: "פינוי דחוף לכירורגיה ילדים", maxScore: 2 },
        { id: "P10-P3-A3", text: "ניטור SpO2, BP ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P11-P1", title: "הערכה ראשונית", actions: [
        { id: "P11-P1-A1", text: "גלוקומטר – היפרגליקמיה, כיטוים", maxScore: 2 },
        { id: "P11-P1-A2", text: "הערכת הידרציה – turgor, mucous membranes", maxScore: 2 },
        { id: "P11-P1-A3", text: "Kussmaul breathing, acetone breath", maxScore: 2 },
        { id: "P11-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "P11-P2", title: "טיפול", actions: [
        { id: "P11-P2-A1", text: "נוזלים Normal Saline 10-20ml/kg – לא מהיר מדי!", maxScore: 2 },
        { id: "P11-P2-A2", text: "לא אינסולין בשדה ב-DKA ילד", maxScore: 2 },
        { id: "P11-P2-A3", text: "ניטור GCS – cerebral edema סיכון!", maxScore: 2 },
        { id: "P11-P2-A4", text: "ECG – היפרקלמיה/היפוקלמיה", maxScore: 2 },
      ]},
      { id: "P11-P3", title: "פינוי", actions: [
        { id: "P11-P3-A1", text: "Pre-alert – DKA ילד, גיל, גלוקוז, GCS", maxScore: 2 },
        { id: "P11-P3-A2", text: "פינוי לICU ילדים", maxScore: 2 },
        { id: "P11-P3-A3", text: "ניטור GCS, גלוקוז – cerebral edema", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P12-P1", title: "הערכה ראשונית", actions: [
        { id: "P12-P1-A1", text: "glass test – non-blanching rash = meningococcemia!", maxScore: 2 },
        { id: "P12-P1-A2", text: "הערכת הלם – septic shock", maxScore: 2 },
        { id: "P12-P1-A3", text: "O2 high-flow, IO/IV גישה מהירה", maxScore: 2 },
        { id: "P12-P1-A4", text: "בידוד", maxScore: 2 },
      ]},
      { id: "P12-P2", title: "טיפול", actions: [
        { id: "P12-P2-A1", text: "כרבי IM מיידי – לפני כל דבר אחר", maxScore: 2 },
        { id: "P12-P2-A2", text: "נוזלים 20ml/kg NS bolus", maxScore: 2 },
        { id: "P12-P2-A3", text: "דקסמתזון 0.15mg/kg IV", maxScore: 2 },
        { id: "P12-P2-A4", text: "RSI אם GCS ירוד", maxScore: 2 },
      ]},
      { id: "P12-P3", title: "פינוי", actions: [
        { id: "P12-P3-A1", text: "Pre-alert – meningococcemia, פריחה, הלם, כרבי", maxScore: 2 },
        { id: "P12-P3-A2", text: "פינוי דחוף לICU ילדים", maxScore: 2 },
        { id: "P12-P3-A3", text: "דיווח בריאות הציבור", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P13-P1", title: "הערכה ראשונית", actions: [
        { id: "P13-P1-A1", text: "זיהוי אנפילקסיס – אלרגן, urticaria, bronchospasm", maxScore: 2 },
        { id: "P13-P1-A2", text: "מינון אדרנלין לילד – 0.01mg/kg IM (max 0.5mg)", maxScore: 2 },
        { id: "P13-P1-A3", text: "O2 high-flow, IO/IV", maxScore: 2 },
        { id: "P13-P1-A4", text: "ניטור SpO2, BP, stridor", maxScore: 2 },
      ]},
      { id: "P13-P2", title: "טיפול", actions: [
        { id: "P13-P2-A1", text: "אדרנלין 0.01mg/kg IM (1:1000)", maxScore: 2 },
        { id: "P13-P2-A2", text: "נוזלים NS 20ml/kg bolus", maxScore: 2 },
        { id: "P13-P2-A3", text: "סלבוטמול נבולייזר לברונכוספזם", maxScore: 2 },
        { id: "P13-P2-A4", text: "הידרוקורטיזון 4mg/kg IV", maxScore: 2 },
      ]},
      { id: "P13-P3", title: "פינוי", actions: [
        { id: "P13-P3-A1", text: "Pre-alert – אנפילקסיס ילד, גיל, אדרנלין, BP", maxScore: 2 },
        { id: "P13-P3-A2", text: "פינוי לניטור rebound", maxScore: 2 },
        { id: "P13-P3-A3", text: "מנה שנייה אדרנלין IM אחרי 5 דקות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P14-P1", title: "הערכה ראשונית", actions: [
        { id: "P14-P1-A1", text: "חסימה חלקית vs מלאה – silent cough = complete", maxScore: 2 },
        { id: "P14-P1-A2", text: "לא בדיקת אצבע עיוורת – מסוכן!", maxScore: 2 },
        { id: "P14-P1-A3", text: "שיטת Heimlich – >1 שנה, 5 abdominal thrusts", maxScore: 2 },
        { id: "P14-P1-A4", text: "גב ילד – 5 back blows", maxScore: 2 },
      ]},
      { id: "P14-P2", title: "טיפול", actions: [
        { id: "P14-P2-A1", text: "5 back blows + 5 chest thrusts (ילד>1 שנה)", maxScore: 2 },
        { id: "P14-P2-A2", text: "אם אובד הכרה – CPR ולארינגוסקופיה", maxScore: 2 },
        { id: "P14-P2-A3", text: "הסרת גוף זר בגרון אם גלוי", maxScore: 2 },
        { id: "P14-P2-A4", text: "O2, BVM אם נדרש", maxScore: 2 },
      ]},
      { id: "P14-P3", title: "פינוי", actions: [
        { id: "P14-P3-A1", text: "פינוי גם לאחר שחרור – חשד לגוף זר ריאות", maxScore: 2 },
        { id: "P14-P3-A2", text: "Pre-alert – FBAO ילד, גיל, SpO2, ניהול", maxScore: 2 },
        { id: "P14-P3-A3", text: "ניטור SpO2, נשימה בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P15-P1", title: "הערכה ראשונית", actions: [
        { id: "P15-P1-A1", text: "C-spine immobilization ילד", maxScore: 2 },
        { id: "P15-P1-A2", text: "GCS ילד, pupils, Cushing's", maxScore: 2 },
        { id: "P15-P1-A3", text: "Battle's sign, raccoon eyes – base skull fracture", maxScore: 2 },
        { id: "P15-P1-A4", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "P15-P2", title: "טיפול", actions: [
        { id: "P15-P2-A1", text: "ניהול airway – RSI אם GCS≤8", maxScore: 2 },
        { id: "P15-P2-A2", text: "ראש 30° – ICP", maxScore: 2 },
        { id: "P15-P2-A3", text: "BP מטרה – MAP ≥ גיל+40 mmHg", maxScore: 2 },
        { id: "P15-P2-A4", text: "מניטול ילד 0.5g/kg IV אם herniation", maxScore: 2 },
      ]},
      { id: "P15-P3", title: "פינוי", actions: [
        { id: "P15-P3-A1", text: "Pre-alert – pediatric TBI, GCS, pupils, RSI", maxScore: 2 },
        { id: "P15-P3-A2", text: "פינוי לנוירוכירורגיה ילדים", maxScore: 2 },
        { id: "P15-P3-A3", text: "ניטור GCS serial, BP, EtCO2", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P16-P1", title: "הערכה ראשונית", actions: [
        { id: "P16-P1-A1", text: "הערכת צהבת – sclerae, skin, craniocaudal spread", maxScore: 2 },
        { id: "P16-P1-A2", text: "Bilirubin encephalopathy (kernicterus) – hypertonia", maxScore: 2 },
        { id: "P16-P1-A3", text: "GCS יילוד, O2, חימום", maxScore: 2 },
        { id: "P16-P1-A4", text: "גלוקוז, ניטור", maxScore: 2 },
      ]},
      { id: "P16-P2", title: "טיפול", actions: [
        { id: "P16-P2-A1", text: "O2, תמיכה נשימתית אם נדרש", maxScore: 2 },
        { id: "P16-P2-A2", text: "גלוקוז IV אם היפוגליקמיה", maxScore: 2 },
        { id: "P16-P2-A3", text: "מנה הוורידית לABO incompatibility – בית חולים", maxScore: 2 },
        { id: "P16-P2-A4", text: "חימום ומניעת hypothermia", maxScore: 2 },
      ]},
      { id: "P16-P3", title: "פינוי", actions: [
        { id: "P16-P3-A1", text: "Pre-alert – neonatal jaundice critical, kernicterus, גיל", maxScore: 2 },
        { id: "P16-P3-A2", text: "פינוי דחוף לNICU – exchange transfusion", maxScore: 2 },
        { id: "P16-P3-A3", text: "ניטור SpO2, גלוקוז, mentation", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P17-P1", title: "הערכה ראשונית", actions: [
        { id: "P17-P1-A1", text: "הלם ספטי ילד – warm vs cold shock", maxScore: 2 },
        { id: "P17-P1-A2", text: "IO/IV מהיר – fluid resuscitation", maxScore: 2 },
        { id: "P17-P1-A3", text: "O2 high-flow, ניטור", maxScore: 2 },
        { id: "P17-P1-A4", text: "גלוקומטר", maxScore: 2 },
      ]},
      { id: "P17-P2", title: "טיפול", actions: [
        { id: "P17-P2-A1", text: "נוזלים 20ml/kg NS bolus – חזור אם ללא שיפור", maxScore: 2 },
        { id: "P17-P2-A2", text: "כרבי IV – wide spectrum", maxScore: 2 },
        { id: "P17-P2-A3", text: "RSI אם GCS ירוד", maxScore: 2 },
        { id: "P17-P2-A4", text: "Noradrenaline אם נוזלים נכשלים", maxScore: 2 },
      ]},
      { id: "P17-P3", title: "פינוי", actions: [
        { id: "P17-P3-A1", text: "Pre-alert – septic shock ילד, BP, כרבי, IO", maxScore: 2 },
        { id: "P17-P3-A2", text: "פינוי לICU ילדים", maxScore: 2 },
        { id: "P17-P3-A3", text: "ניטור BP, GCS, capillary refill", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "P18-P1", title: "הערכה ראשונית", actions: [
        { id: "P18-P1-A1", text: "CPR ילד מיידי – 30:2 (2 מציל)", maxScore: 2 },
        { id: "P18-P1-A2", text: "5 rescue breaths ראשונות ב-drowning", maxScore: 2 },
        { id: "P18-P1-A3", text: "AED/Defib – VF?", maxScore: 2 },
        { id: "P18-P1-A4", text: "מדידת טמפרטורה – היפותרמיה", maxScore: 2 },
      ]},
      { id: "P18-P2", title: "טיפול", actions: [
        { id: "P18-P2-A1", text: "אינטובציה מהירה לאחר CPR", maxScore: 2 },
        { id: "P18-P2-A2", text: "IO/IV – אדרנלין 0.01mg/kg", maxScore: 2 },
        { id: "P18-P2-A3", text: "לא הכרזת מוות אם היפותרמי", maxScore: 2 },
        { id: "P18-P2-A4", text: "נוזלים חמים, חימום פעיל", maxScore: 2 },
      ]},
      { id: "P18-P3", title: "פינוי", actions: [
        { id: "P18-P3-A1", text: "Pre-alert – pediatric drowning, CPR, היפותרמיה, גיל", maxScore: 2 },
        { id: "P18-P3-A2", text: "פינוי לICU ילדים – ECMO?", maxScore: 2 },
        { id: "P18-P3-A3", text: "ניטור טמפרטורה, GCS, SpO2", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O02-P1", title: "הערכה ראשונית", actions: [
        { id: "O02-P1-A1", text: "לא בדיקה נרתיקית – שליה קדמית!", maxScore: 2 },
        { id: "O02-P1-A2", text: "מיקום שמאל – IVC decompression", maxScore: 2 },
        { id: "O02-P1-A3", text: "כמות דימום, צבע, כאב", maxScore: 2 },
        { id: "O02-P1-A4", text: "O2, גישה ורידית x2, ניטור FHR אם ניתן", maxScore: 2 },
      ]},
      { id: "O02-P2", title: "טיפול", actions: [
        { id: "O02-P2-A1", text: "נוזלים IV לתמיכה המודינמית", maxScore: 2 },
        { id: "O02-P2-A2", text: "ניטור BP ודופק עוברי", maxScore: 2 },
        { id: "O02-P2-A3", text: "O2 high-flow לתמיכה עוברית", maxScore: 2 },
        { id: "O02-P2-A4", text: "לא פרוסטגלנדינים/טוקוליטים בשדה", maxScore: 2 },
      ]},
      { id: "O02-P3", title: "פינוי", actions: [
        { id: "O02-P3-A1", text: "Pre-alert – placenta previa, שבוע הריון, דימום, BP", maxScore: 2 },
        { id: "O02-P3-A2", text: "פינוי לחדר לידה/גינקולוגיה", maxScore: 2 },
        { id: "O02-P3-A3", text: "ניטור BP, דימום, FHR ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O03-P1", title: "הערכה ראשונית", actions: [
        { id: "O03-P1-A1", text: "ראיית חבל טבור = צניחה – emergency!", maxScore: 2 },
        { id: "O03-P1-A2", text: "מיקום Knee-Chest לחץ על ראש עובר מהנרתיק", maxScore: 2 },
        { id: "O03-P1-A3", text: "FHR – דקיקות?", maxScore: 2 },
        { id: "O03-P1-A4", text: "O2 100% לאם", maxScore: 2 },
      ]},
      { id: "O03-P2", title: "טיפול", actions: [
        { id: "O03-P2-A1", text: "ידיים בנרתיק – הרמת הראש מהחבל!", maxScore: 2 },
        { id: "O03-P2-A2", text: "לא להחזיר חבל לנרתיק", maxScore: 2 },
        { id: "O03-P2-A3", text: "חבל עטוף בבד לח חמים", maxScore: 2 },
        { id: "O03-P2-A4", text: "מנח knee-chest כל הדרך לבית חולים", maxScore: 2 },
      ]},
      { id: "O03-P3", title: "פינוי", actions: [
        { id: "O03-P3-A1", text: "Pre-alert – cord prolapse, FHR, ניתוח קיסרי דחוף", maxScore: 2 },
        { id: "O03-P3-A2", text: "פינוי מהיר עם ידיים בנרתיק – לא לעזוב!", maxScore: 2 },
        { id: "O03-P3-A3", text: "ניטור FHR ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O04-P1", title: "הערכה ראשונית", actions: [
        { id: "O04-P1-A1", text: "זיהוי shoulder dystocia – turtle sign, ראש לא מתקדם", maxScore: 2 },
        { id: "O04-P1-A2", text: "קריאת עזרה – צוות נוסף", maxScore: 2 },
        { id: "O04-P1-A3", text: "McRoberts maneuver – גמישות ירך מקסימלית", maxScore: 2 },
        { id: "O04-P1-A4", text: "O2 100% לאם, ניטור", maxScore: 2 },
      ]},
      { id: "O04-P2", title: "טיפול", actions: [
        { id: "O04-P2-A1", text: "לחץ suprapubic – לא fundal pressure!", maxScore: 2 },
        { id: "O04-P2-A2", text: "McRoberts + לחץ suprapubic = שיטה ראשונה", maxScore: 2 },
        { id: "O04-P2-A3", text: "Rubin II / Wood screw maneuver אם ראשון נכשל", maxScore: 2 },
        { id: "O04-P2-A4", text: "Gaskin – כל ארבע (all-fours) אם אחרים נכשלים", maxScore: 2 },
      ]},
      { id: "O04-P3", title: "פינוי", actions: [
        { id: "O04-P3-A1", text: "Pre-alert – shoulder dystocia, FHR, נסיונות, שבוע", maxScore: 2 },
        { id: "O04-P3-A2", text: "פינוי מהיר לחדר לידה", maxScore: 2 },
        { id: "O04-P3-A3", text: "תיעוד כל maneuver ותוצאה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O05-P1", title: "הערכה ראשונית", actions: [
        { id: "O05-P1-A1", text: "הערכת הלם היפוולמי – 4Ts: tone, trauma, tissue, thrombin", maxScore: 2 },
        { id: "O05-P1-A2", text: "גישה ורידית x2, O2 high-flow", maxScore: 2 },
        { id: "O05-P1-A3", text: "בדיקת רחם – atony?", maxScore: 2 },
        { id: "O05-P1-A4", text: "ניטור BP, SpO2, mentation", maxScore: 2 },
      ]},
      { id: "O05-P2", title: "טיפול", actions: [
        { id: "O05-P2-A1", text: "עיסוי רחם bimanual אם atony", maxScore: 2 },
        { id: "O05-P2-A2", text: "אוקסיטוצין 10 IU IM – uterotonics", maxScore: 2 },
        { id: "O05-P2-A3", text: "נוזלים IV מאסיביים – blood products בית חולים", maxScore: 2 },
        { id: "O05-P2-A4", text: "TXA 1g IV תוך 3 שעות מלידה", maxScore: 2 },
      ]},
      { id: "O05-P3", title: "פינוי", actions: [
        { id: "O05-P3-A1", text: "Pre-alert – PPH, אוקסיטוצין, BP, TXA", maxScore: 2 },
        { id: "O05-P3-A2", text: "פינוי מהיר לחדר ניתוח/כלי דם", maxScore: 2 },
        { id: "O05-P3-A3", text: "ניטור BP, Hb, mentation ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O06-P1", title: "הערכה ראשונית", actions: [
        { id: "O06-P1-A1", text: "חשד הריון חוץ-רחמי – כאב, אמנוריאה, דימום", maxScore: 2 },
        { id: "O06-P1-A2", text: "FAST – free fluid בטן", maxScore: 2 },
        { id: "O06-P1-A3", text: "O2, גישה ורידית x2", maxScore: 2 },
        { id: "O06-P1-A4", text: "ניטור BP – הלם!", maxScore: 2 },
      ]},
      { id: "O06-P2", title: "טיפול", actions: [
        { id: "O06-P2-A1", text: "נוזלים IV aggressive – הלם היפוולמי", maxScore: 2 },
        { id: "O06-P2-A2", text: "TXA 1g IV", maxScore: 2 },
        { id: "O06-P2-A3", text: "O2 high-flow, מיקום supine", maxScore: 2 },
        { id: "O06-P2-A4", text: "ניטור BP, SpO2 ברציפות", maxScore: 2 },
      ]},
      { id: "O06-P3", title: "פינוי", actions: [
        { id: "O06-P3-A1", text: "Pre-alert – suspected ectopic, BP, FAST positive", maxScore: 2 },
        { id: "O06-P3-A2", text: "פינוי דחוף לגינקולוגיה/ניתוח", maxScore: 2 },
        { id: "O06-P3-A3", text: "ניטור BP, mentation ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O07-P1", title: "הערכה ראשונית", actions: [
        { id: "O07-P1-A1", text: "HELLP – Hemolysis, EL, LP", maxScore: 2 },
        { id: "O07-P1-A2", text: "BP, כאב RUQ, שינוי ראיה", maxScore: 2 },
        { id: "O07-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "O07-P1-A4", text: "FAST – liver hematoma/rupture", maxScore: 2 },
      ]},
      { id: "O07-P2", title: "טיפול", actions: [
        { id: "O07-P2-A1", text: "מגנזיום סולפט 4g IV loading dose", maxScore: 2 },
        { id: "O07-P2-A2", text: "הורדת BP זהיר – labetalol/hydralazine", maxScore: 2 },
        { id: "O07-P2-A3", text: "מיקום שמאל", maxScore: 2 },
        { id: "O07-P2-A4", text: "ניטור תסמינים – פרכוסים?", maxScore: 2 },
      ]},
      { id: "O07-P3", title: "פינוי", actions: [
        { id: "O07-P3-A1", text: "Pre-alert – HELLP, BP, מגנזיום, שבוע הריון", maxScore: 2 },
        { id: "O07-P3-A2", text: "פינוי לחדר לידה בכח", maxScore: 2 },
        { id: "O07-P3-A3", text: "ניטור BP, פרכוסים, FHR", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O08-P1", title: "הערכה ראשונית", actions: [
        { id: "O08-P1-A1", text: "Hyperemesis gravidarum – >3% ירידת משקל, ketonuria", maxScore: 2 },
        { id: "O08-P1-A2", text: "הערכת התייבשות – mucous membranes, turgor, urine", maxScore: 2 },
        { id: "O08-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "O08-P1-A4", text: "גלוקומטר – hyperemesis + hypoglycemia", maxScore: 2 },
      ]},
      { id: "O08-P2", title: "טיפול", actions: [
        { id: "O08-P2-A1", text: "נוזלים IV NS 500ml בנסיעה", maxScore: 2 },
        { id: "O08-P2-A2", text: "מטוקלופרמיד 10mg IV antiemetic", maxScore: 2 },
        { id: "O08-P2-A3", text: "Thiamine לפני גלוקוז – Wernicke risk", maxScore: 2 },
        { id: "O08-P2-A4", text: "נוחות חולה, הרגעה", maxScore: 2 },
      ]},
      { id: "O08-P3", title: "פינוי", actions: [
        { id: "O08-P3-A1", text: "Pre-alert – hyperemesis, התייבשות, שבוע", maxScore: 2 },
        { id: "O08-P3-A2", text: "פינוי לאשפוז גינקולוגיה", maxScore: 2 },
        { id: "O08-P3-A3", text: "ניטור SpO2, BP, GCS", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O09-P1", title: "הערכה ראשונית", actions: [
        { id: "O09-P1-A1", text: "הערכת שלב לידה – crowning, rupture of membranes", maxScore: 2 },
        { id: "O09-P1-A2", text: "הכנת ציוד לידה – clamps x2, גזה, שמיכה", maxScore: 2 },
        { id: "O09-P1-A3", text: "O2, גישה ורידית לאם", maxScore: 2 },
        { id: "O09-P1-A4", text: "FHR ניטור", maxScore: 2 },
      ]},
      { id: "O09-P2", title: "טיפול", actions: [
        { id: "O09-P2-A1", text: "תמיכת ראש עדינה – לא למשוך!", maxScore: 2 },
        { id: "O09-P2-A2", text: "בדיקת חבל צוואר – loop around neck", maxScore: 2 },
        { id: "O09-P2-A3", text: "לידת כתפיים – anterior shoulder ראשון", maxScore: 2 },
        { id: "O09-P2-A4", text: "הערכת ילוד – Apgar, חימום, ייבוש", maxScore: 2 },
      ]},
      { id: "O09-P3", title: "פינוי", actions: [
        { id: "O09-P3-A1", text: "Pre-alert – field delivery, Apgar, שליה?", maxScore: 2 },
        { id: "O09-P3-A2", text: "פינוי לחדר לידה – אם ושליה", maxScore: 2 },
        { id: "O09-P3-A3", text: "ניטור PPH, FHR ילוד, Apgar", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O10-P1", title: "הערכה ראשונית", actions: [
        { id: "O10-P1-A1", text: "הצגה רגלית – breech presentation זיהוי", maxScore: 2 },
        { id: "O10-P1-A2", text: "O2, גישה ורידית, קריאת עזרה", maxScore: 2 },
        { id: "O10-P1-A3", text: "FHR ניטור ברציפות", maxScore: 2 },
        { id: "O10-P1-A4", text: "אם ניתן – עצור לידה ופנה מיידית", maxScore: 2 },
      ]},
      { id: "O10-P2", title: "טיפול", actions: [
        { id: "O10-P2-A1", text: "לא לעצור – לידה ספונטנית ברגליים אם כבר מתקדמת", maxScore: 2 },
        { id: "O10-P2-A2", text: "תמיכת גוף ילד – לא למשוך!", maxScore: 2 },
        { id: "O10-P2-A3", text: "Mauriceau-Smellie-Veit לראש", maxScore: 2 },
        { id: "O10-P2-A4", text: "ניטור asphyxia, חימום ילוד", maxScore: 2 },
      ]},
      { id: "O10-P3", title: "פינוי", actions: [
        { id: "O10-P3-A1", text: "Pre-alert – breech delivery, FHR, ניתוח קיסרי?", maxScore: 2 },
        { id: "O10-P3-A2", text: "פינוי מהיר", maxScore: 2 },
        { id: "O10-P3-A3", text: "ניטור ילוד, Apgar, SpO2", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O11-P1", title: "הערכה ראשונית", actions: [
        { id: "O11-P1-A1", text: "זיהוי AFE – תחילה קטסטרופלית, intrapartum", maxScore: 2 },
        { id: "O11-P1-A2", text: "CPR אם cardiac arrest", maxScore: 2 },
        { id: "O11-P1-A3", text: "O2 100%, גישה ורידית x2", maxScore: 2 },
        { id: "O11-P1-A4", text: "ניטור ברציפות", maxScore: 2 },
      ]},
      { id: "O11-P2", title: "טיפול", actions: [
        { id: "O11-P2-A1", text: "נוזלים IV aggressive, וזופרסורים", maxScore: 2 },
        { id: "O11-P2-A2", text: "RSI – airway protection", maxScore: 2 },
        { id: "O11-P2-A3", text: "CPR בצד שמאל 15°, נפרסץ מיידי", maxScore: 2 },
        { id: "O11-P2-A4", text: "דיסקוסיה DIC – blood products בית חולים", maxScore: 2 },
      ]},
      { id: "O11-P3", title: "פינוי", actions: [
        { id: "O11-P3-A1", text: "Pre-alert – AFE, cardiac arrest, pregnancy", maxScore: 2 },
        { id: "O11-P3-A2", text: "פינוי מהיר לICU מיילדות", maxScore: 2 },
        { id: "O11-P3-A3", text: "ניטור מאוד פעיל", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O12-P1", title: "הערכה ראשונית", actions: [
        { id: "O12-P1-A1", text: "גלוקומטר מיידי – ALWAYS בAMS הריון", maxScore: 2 },
        { id: "O12-P1-A2", text: "הערכת FHR", maxScore: 2 },
        { id: "O12-P1-A3", text: "O2, גישה ורידית, מיקום שמאל", maxScore: 2 },
        { id: "O12-P1-A4", text: "ניטור SpO2, BP, mentation", maxScore: 2 },
      ]},
      { id: "O12-P2", title: "טיפול", actions: [
        { id: "O12-P2-A1", text: "גלוקוז 50% 50ml IV – hypoglycemia הריון", maxScore: 2 },
        { id: "O12-P2-A2", text: "בדיקת גלוקוז 15 דקות לאחר גלוקוז", maxScore: 2 },
        { id: "O12-P2-A3", text: "O2 לשיפור utero-placental perfusion", maxScore: 2 },
        { id: "O12-P2-A4", text: "מיקום שמאל – IVC compression", maxScore: 2 },
      ]},
      { id: "O12-P3", title: "פינוי", actions: [
        { id: "O12-P3-A1", text: "Pre-alert – hypoglycemia הריון, שבוע, FHR", maxScore: 2 },
        { id: "O12-P3-A2", text: "פינוי לחדר לידה לניטור עוברי", maxScore: 2 },
        { id: "O12-P3-A3", text: "ניטור גלוקוז, FHR ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O13-P1", title: "הערכה ראשונית", actions: [
        { id: "O13-P1-A1", text: "זיהוי – uterine rupture: pain, deceleration, maternal shock", maxScore: 2 },
        { id: "O13-P1-A2", text: "O2, גישה ורידית x2", maxScore: 2 },
        { id: "O13-P1-A3", text: "FHR ניטור", maxScore: 2 },
        { id: "O13-P1-A4", text: "FAST – free fluid", maxScore: 2 },
      ]},
      { id: "O13-P2", title: "טיפול", actions: [
        { id: "O13-P2-A1", text: "נוזלים IV aggressive", maxScore: 2 },
        { id: "O13-P2-A2", text: "TXA 1g IV", maxScore: 2 },
        { id: "O13-P2-A3", text: "O2 high-flow, מיקום שמאל", maxScore: 2 },
        { id: "O13-P2-A4", text: "ניטור BP, FHR ברציפות", maxScore: 2 },
      ]},
      { id: "O13-P3", title: "פינוי", actions: [
        { id: "O13-P3-A1", text: "Pre-alert – uterine rupture, קיסרי קודם, BP, FHR", maxScore: 2 },
        { id: "O13-P3-A2", text: "פינוי דחוף לניתוח קיסרי חירום", maxScore: 2 },
        { id: "O13-P3-A3", text: "ניטור מלא בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O14-P1", title: "הערכה ראשונית", actions: [
        { id: "O14-P1-A1", text: "abruptio placentae – painful bleeding, rigid uterus", maxScore: 2 },
        { id: "O14-P1-A2", text: "FHR ניטור", maxScore: 2 },
        { id: "O14-P1-A3", text: "O2, גישה ורידית x2", maxScore: 2 },
        { id: "O14-P1-A4", text: "FAST – דימום מוסתר?", maxScore: 2 },
      ]},
      { id: "O14-P2", title: "טיפול", actions: [
        { id: "O14-P2-A1", text: "נוזלים IV, TXA 1g", maxScore: 2 },
        { id: "O14-P2-A2", text: "O2 high-flow, מיקום שמאל", maxScore: 2 },
        { id: "O14-P2-A3", text: "ניטור DIC – coagulopathy", maxScore: 2 },
        { id: "O14-P2-A4", text: "ניטור BP, FHR", maxScore: 2 },
      ]},
      { id: "O14-P3", title: "פינוי", actions: [
        { id: "O14-P3-A1", text: "Pre-alert – abruptio, שבוע, FHR, BP", maxScore: 2 },
        { id: "O14-P3-A2", text: "פינוי לחדר לידה/ניתוח", maxScore: 2 },
        { id: "O14-P3-A3", text: "ניטור DIC, BP, mentation", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O15-P1", title: "הערכה ראשונית", actions: [
        { id: "O15-P1-A1", text: "הגדרת preterm – <37 שבועות עם צירים", maxScore: 2 },
        { id: "O15-P1-A2", text: "FHR ניטור, O2, מיקום שמאל", maxScore: 2 },
        { id: "O15-P1-A3", text: "הכנת ציוד NICU", maxScore: 2 },
        { id: "O15-P1-A4", text: "גישה ורידית, ניטור", maxScore: 2 },
      ]},
      { id: "O15-P2", title: "טיפול", actions: [
        { id: "O15-P2-A1", text: "לא tocolytics בשדה", maxScore: 2 },
        { id: "O15-P2-A2", text: "מגנזיום 4g IV – neuroprotection לעובר <32w", maxScore: 2 },
        { id: "O15-P2-A3", text: "אם לידה בלתי נמנעת – הכנה ל-preterm delivery", maxScore: 2 },
        { id: "O15-P2-A4", text: "ניטור FHR ברציפות", maxScore: 2 },
      ]},
      { id: "O15-P3", title: "פינוי", actions: [
        { id: "O15-P3-A1", text: "Pre-alert – preterm labor שבוע 30, NICU, מגנזיום", maxScore: 2 },
        { id: "O15-P3-A2", text: "פינוי לבית חולים עם NICU", maxScore: 2 },
        { id: "O15-P3-A3", text: "ניטור FHR, צירים בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "O16-P1", title: "הערכה ראשונית", actions: [
        { id: "O16-P1-A1", text: "חשד הריון מולרי – דימום מוקדם, BP גבוה, גודל גדול", maxScore: 2 },
        { id: "O16-P1-A2", text: "כמות דימום, מצב המודינמי", maxScore: 2 },
        { id: "O16-P1-A3", text: "O2, גישה ורידית x2, ניטור", maxScore: 2 },
        { id: "O16-P1-A4", text: "FAST – free fluid?", maxScore: 2 },
      ]},
      { id: "O16-P2", title: "טיפול", actions: [
        { id: "O16-P2-A1", text: "נוזלים IV לתמיכה המודינמית", maxScore: 2 },
        { id: "O16-P2-A2", text: "לא oxytocin בשדה ב-molar", maxScore: 2 },
        { id: "O16-P2-A3", text: "BP control זהיר – מטרה לא מתחת ל-150", maxScore: 2 },
        { id: "O16-P2-A4", text: "ניטור BP, דימום ברציפות", maxScore: 2 },
      ]},
      { id: "O16-P3", title: "פינוי", actions: [
        { id: "O16-P3-A1", text: "Pre-alert – suspected molar, BP, דימום, שבוע", maxScore: 2 },
        { id: "O16-P3-A2", text: "פינוי לגינקולוגיה – evacuation", maxScore: 2 },
        { id: "O16-P3-A3", text: "ניטור BP, SpO2, mentation", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X03-P1", title: "הערכה ראשונית", actions: [
        { id: "X03-P1-A1", text: "ECG – QRS >100ms, חיפוש R בaVR", maxScore: 2 },
        { id: "X03-P1-A2", text: "ABCDE, GCS, ניהול airway", maxScore: 2 },
        { id: "X03-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "X03-P1-A4", text: "אנמנזה – תרופה, מינון, זמן", maxScore: 2 },
      ]},
      { id: "X03-P2", title: "טיפול", actions: [
        { id: "X03-P2-A1", text: "נתרן ביקרבונאט 8.4% 1-2mmol/kg IV – QRS narrowing", maxScore: 2 },
        { id: "X03-P2-A2", text: "RSI – GCS ירוד, airway protection", maxScore: 2 },
        { id: "X03-P2-A3", text: "נוזלים IV לBP", maxScore: 2 },
        { id: "X03-P2-A4", text: "הימנע מ-physostigmine, flumazenil", maxScore: 2 },
      ]},
      { id: "X03-P3", title: "פינוי", actions: [
        { id: "X03-P3-A1", text: "Pre-alert – TCA overdose, ECG QRS, NaHCO3", maxScore: 2 },
        { id: "X03-P3-A2", text: "פינוי לICU עם המשך NaHCO3", maxScore: 2 },
        { id: "X03-P3-A3", text: "ניטור ECG ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X04-P1", title: "הערכה ראשונית", actions: [
        { id: "X04-P1-A1", text: "כמות ומינון – >150mg/kg מסוכן", maxScore: 2 },
        { id: "X04-P1-A2", text: "זמן נטילה – ≤1 שעה? activated charcoal", maxScore: 2 },
        { id: "X04-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "X04-P1-A4", text: "הסברת silence period – כבד ייפגע מאוחר", maxScore: 2 },
      ]},
      { id: "X04-P2", title: "טיפול", actions: [
        { id: "X04-P2-A1", text: "Activated charcoal 1g/kg PO אם ≤1 שעה", maxScore: 2 },
        { id: "X04-P2-A2", text: "NAC – N-acetylcysteine (בבית חולים)", maxScore: 2 },
        { id: "X04-P2-A3", text: "לא לאלץ הקאה – שאיפה!", maxScore: 2 },
        { id: "X04-P2-A4", text: "ניטור GCS, עייפות, RUQ pain", maxScore: 2 },
      ]},
      { id: "X04-P3", title: "פינוי", actions: [
        { id: "X04-P3-A1", text: "Pre-alert – paracetamol OD, מינון, זמן, AC", maxScore: 2 },
        { id: "X04-P3-A2", text: "פינוי לכולם – liver failure מאוחרת", maxScore: 2 },
        { id: "X04-P3-A3", text: "ניטור LFT, GCS בנסיעה", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X05-P1", title: "הערכה ראשונית", actions: [
        { id: "X05-P1-A1", text: "ליתיום toxicity – SLUD: seizures, level consciousness, urinary", maxScore: 2 },
        { id: "X05-P1-A2", text: "גלוקומטר, אנמנזה – תרופות, זמן", maxScore: 2 },
        { id: "X05-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "X05-P1-A4", text: "ECG – ST changes, T wave", maxScore: 2 },
      ]},
      { id: "X05-P2", title: "טיפול", actions: [
        { id: "X05-P2-A1", text: "נוזלים NS IV – dilution ו-renal clearance", maxScore: 2 },
        { id: "X05-P2-A2", text: "עוויתות – בנזודיאזפין", maxScore: 2 },
        { id: "X05-P2-A3", text: "הימנע מ-NSAID/diuretics – מגבירים ליתיום", maxScore: 2 },
        { id: "X05-P2-A4", text: "ניטור GCS, עוויתות, ECG", maxScore: 2 },
      ]},
      { id: "X05-P3", title: "פינוי", actions: [
        { id: "X05-P3-A1", text: "Pre-alert – lithium toxicity, ECG, עוויתות, GCS", maxScore: 2 },
        { id: "X05-P3-A2", text: "פינוי לNephrology – dialysis אפשרי", maxScore: 2 },
        { id: "X05-P3-A3", text: "ניטור ברציפות – serum lithium", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X06-P1", title: "הערכה ראשונית", actions: [
        { id: "X06-P1-A1", text: "ECG – ברדיקרדיה, PR prolongation, AV block", maxScore: 2 },
        { id: "X06-P1-A2", text: "גלוקומטר – beta-blocker = hypoglycemia", maxScore: 2 },
        { id: "X06-P1-A3", text: "O2, גישה ורידית x2, ניטור", maxScore: 2 },
        { id: "X06-P1-A4", text: "אנמנזה – תרופה, מינון, זמן", maxScore: 2 },
      ]},
      { id: "X06-P2", title: "טיפול", actions: [
        { id: "X06-P2-A1", text: "High dose insulin 1unit/kg bolus + גלוקוז – HDIE", maxScore: 2 },
        { id: "X06-P2-A2", text: "גלוקגון 5-10mg IV – inotrope", maxScore: 2 },
        { id: "X06-P2-A3", text: "קצב חיצוני + אטרופין לברדיקרדיה", maxScore: 2 },
        { id: "X06-P2-A4", text: "Lipid emulsion 20% אם cardiac arrest", maxScore: 2 },
      ]},
      { id: "X06-P3", title: "פינוי", actions: [
        { id: "X06-P3-A1", text: "Pre-alert – beta-blocker OD, ECG, BP, גלוקגון", maxScore: 2 },
        { id: "X06-P3-A2", text: "פינוי לICU – ECMO option", maxScore: 2 },
        { id: "X06-P3-A3", text: "ניטור ECG, גלוקוז, BP ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X07-P1", title: "הערכה ראשונית", actions: [
        { id: "X07-P1-A1", text: "ECG – ברדיקרדיה, AV block, PR prolonged", maxScore: 2 },
        { id: "X07-P1-A2", text: "O2, גישה ורידית x2, ניטור", maxScore: 2 },
        { id: "X07-P1-A3", text: "גלוקומטר", maxScore: 2 },
        { id: "X07-P1-A4", text: "אנמנזה – CCB, sustained release?", maxScore: 2 },
      ]},
      { id: "X07-P2", title: "טיפול", actions: [
        { id: "X07-P2-A1", text: "גלוקונאט סידן 10% 10-30ml IV", maxScore: 2 },
        { id: "X07-P2-A2", text: "HDIE – High dose insulin + גלוקוז", maxScore: 2 },
        { id: "X07-P2-A3", text: "קצב חיצוני לברדיקרדיה", maxScore: 2 },
        { id: "X07-P2-A4", text: "Lipid emulsion 20% – cardiac arrest", maxScore: 2 },
      ]},
      { id: "X07-P3", title: "פינוי", actions: [
        { id: "X07-P3-A1", text: "Pre-alert – CCB OD, ECG, סידן, HDIE", maxScore: 2 },
        { id: "X07-P3-A2", text: "פינוי לICU", maxScore: 2 },
        { id: "X07-P3-A3", text: "ניטור ECG, BP ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X08-P1", title: "הערכה ראשונית", actions: [
        { id: "X08-P1-A1", text: "Opioid triad – miosis, respiratory depression, LOC", maxScore: 2 },
        { id: "X08-P1-A2", text: "O2, BVM, נשימות הצלה", maxScore: 2 },
        { id: "X08-P1-A3", text: "גישה ורידית/IO/IM", maxScore: 2 },
        { id: "X08-P1-A4", text: "ABCDE, GCS", maxScore: 2 },
      ]},
      { id: "X08-P2", title: "טיפול", actions: [
        { id: "X08-P2-A1", text: "נלוקסון 0.4mg IV/IM/IN – antidote", maxScore: 2 },
        { id: "X08-P2-A2", text: "חזרה 0.4mg כל 2-3 דקות עד RR>12", maxScore: 2 },
        { id: "X08-P2-A3", text: "ניטור ל-renarcotization – נלוקסון t1/2 קצר!", maxScore: 2 },
        { id: "X08-P2-A4", text: "BVM/אינטובציה אם חוסמה נשימה", maxScore: 2 },
      ]},
      { id: "X08-P3", title: "פינוי", actions: [
        { id: "X08-P3-A1", text: "פינוי – renarcotization ב-IR/fentanyl", maxScore: 2 },
        { id: "X08-P3-A2", text: "Pre-alert – opioid OD, נלוקסון, RR, SpO2", maxScore: 2 },
        { id: "X08-P3-A3", text: "ניטור RR, SpO2, GCS ברציפות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X09-P1", title: "הערכה ראשונית", actions: [
        { id: "X09-P1-A1", text: "ABCDE, GCS, airway protection", maxScore: 2 },
        { id: "X09-P1-A2", text: "שלילת TCA – ECG!", maxScore: 2 },
        { id: "X09-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "X09-P1-A4", text: "גלוקומטר, אנמנזה", maxScore: 2 },
      ]},
      { id: "X09-P2", title: "טיפול", actions: [
        { id: "X09-P2-A1", text: "O2, BVM אם RR<8", maxScore: 2 },
        { id: "X09-P2-A2", text: "Flumazenil – רק אם ידוע ספציפי, זהיר! TCA?", maxScore: 2 },
        { id: "X09-P2-A3", text: "הימנע מflumazenil ב-polypharmacy", maxScore: 2 },
        { id: "X09-P2-A4", text: "ניטור SpO2, GCS ברציפות", maxScore: 2 },
      ]},
      { id: "X09-P3", title: "פינוי", actions: [
        { id: "X09-P3-A1", text: "Pre-alert – BZD OD, GCS, SpO2, שלילת TCA", maxScore: 2 },
        { id: "X09-P3-A2", text: "פינוי לאבחון ועזרה תמיכתית", maxScore: 2 },
        { id: "X09-P3-A3", text: "ניטור SpO2, airway", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X10-P1", title: "הערכה ראשונית", actions: [
        { id: "X10-P1-A1", text: "Hunter criteria – clonus, myoclonus, agitation, diaphoresis", maxScore: 2 },
        { id: "X10-P1-A2", text: "אנמנזה – SSRI, MAOI, tramadol, triptans", maxScore: 2 },
        { id: "X10-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "X10-P1-A4", text: "טמפרטורה, ECG, גלוקוז", maxScore: 2 },
      ]},
      { id: "X10-P2", title: "טיפול", actions: [
        { id: "X10-P2-A1", text: "הפסקת סרוטונרגי – remove the trigger", maxScore: 2 },
        { id: "X10-P2-A2", text: "ציפרוהפטדין 12mg PO – serotonin antagonist", maxScore: 2 },
        { id: "X10-P2-A3", text: "קירור היפרתרמיה – קרח, מים קרים", maxScore: 2 },
        { id: "X10-P2-A4", text: "בנזודיאזפין לאגיטציה/עוויתות", maxScore: 2 },
      ]},
      { id: "X10-P3", title: "פינוי", actions: [
        { id: "X10-P3-A1", text: "Pre-alert – serotonin syndrome, temp, tachycardia", maxScore: 2 },
        { id: "X10-P3-A2", text: "פינוי לICU", maxScore: 2 },
        { id: "X10-P3-A3", text: "ניטור טמפרטורה, ECG, GCS", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X11-P1", title: "הערכה ראשונית", actions: [
        { id: "X11-P1-A1", text: "NMS – WHAR: Weakness/rigidity, Hyperthermia, AMS, Rhabdomyolysis", maxScore: 2 },
        { id: "X11-P1-A2", text: "הבחנה מ-serotonin syndrome – lead pipe rigidity vs clonus", maxScore: 2 },
        { id: "X11-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "X11-P1-A4", text: "טמפרטורה, CK גבוה (הערכה)", maxScore: 2 },
      ]},
      { id: "X11-P2", title: "טיפול", actions: [
        { id: "X11-P2-A1", text: "קירור אגרסיבי – מים קרים, קרח", maxScore: 2 },
        { id: "X11-P2-A2", text: "Dantrolene – muscle relaxant (בבית חולים)", maxScore: 2 },
        { id: "X11-P2-A3", text: "הפסקת נוירולפטי", maxScore: 2 },
        { id: "X11-P2-A4", text: "נוזלים IV – rhabdomyolysis renal protection", maxScore: 2 },
      ]},
      { id: "X11-P3", title: "פינוי", actions: [
        { id: "X11-P3-A1", text: "Pre-alert – NMS, temp 40.5, rigidity, נוירולפטי", maxScore: 2 },
        { id: "X11-P3-A2", text: "פינוי לICU – Dantrolene, cooling", maxScore: 2 },
        { id: "X11-P3-A3", text: "ניטור טמפרטורה, BP, mentation", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X12-P1", title: "הערכה ראשונית", actions: [
        { id: "X12-P1-A1", text: "יציאה מיידית מהסביבה!", maxScore: 2 },
        { id: "X12-P1-A2", text: "SpO2 פולסאוקסימטר לא אמין – COHb גבוה", maxScore: 2 },
        { id: "X12-P1-A3", text: "GCS, FAST – שלילת CVA", maxScore: 2 },
        { id: "X12-P1-A4", text: "CO detector אם זמין", maxScore: 2 },
      ]},
      { id: "X12-P2", title: "טיפול", actions: [
        { id: "X12-P2-A1", text: "O2 100% NRB לכולם – הפחתת t1/2 CO", maxScore: 2 },
        { id: "X12-P2-A2", text: "גישה ורידית, ניטור, O2 ברציפות", maxScore: 2 },
        { id: "X12-P2-A3", text: "RSI אם GCS ירוד", maxScore: 2 },
        { id: "X12-P2-A4", text: "שקילת hyperbaric O2 – הריון, LOC, arrhythmia", maxScore: 2 },
      ]},
      { id: "X12-P3", title: "פינוי", actions: [
        { id: "X12-P3-A1", text: "Pre-alert – CO poisoning, GCS, כולם, hyperbaric?", maxScore: 2 },
        { id: "X12-P3-A2", text: "פינוי לboring – hyperbaric center", maxScore: 2 },
        { id: "X12-P3-A3", text: "ניטור GCS, SpO2 (אמיתי - CO-oximeter בית חולים)", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X13-P1", title: "הערכה ראשונית", actions: [
        { id: "X13-P1-A1", text: "חשד ציאניד – שריפה, bitter almond odor, rapid decompensation", maxScore: 2 },
        { id: "X13-P1-A2", text: "O2 100% NRB מיידי", maxScore: 2 },
        { id: "X13-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "X13-P1-A4", text: "Hydroxocobalamin 5g IV – antidote", maxScore: 2 },
      ]},
      { id: "X13-P2", title: "טיפול", actions: [
        { id: "X13-P2-A1", text: "Hydroxocobalamin 5g IV על 15 דקות", maxScore: 2 },
        { id: "X13-P2-A2", text: "RSI – airway protection", maxScore: 2 },
        { id: "X13-P2-A3", text: "נוזלים IV לBP", maxScore: 2 },
        { id: "X13-P2-A4", text: "הימנע מthiosulfate אם hydroxocobalamin ניתן", maxScore: 2 },
      ]},
      { id: "X13-P3", title: "פינוי", actions: [
        { id: "X13-P3-A1", text: "Pre-alert – cyanide poisoning, hydroxocobalamin, BP", maxScore: 2 },
        { id: "X13-P3-A2", text: "פינוי לICU", maxScore: 2 },
        { id: "X13-P3-A3", text: "ניטור BP, SpO2, lactate (גבוה ב-cyanide)", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X14-P1", title: "הערכה ראשונית", actions: [
        { id: "X14-P1-A1", text: "אנמנזה – אלכוהול לא ידוע, ראיה, חמצת", maxScore: 2 },
        { id: "X14-P1-A2", text: "Kussmaul breathing = metabolic acidosis", maxScore: 2 },
        { id: "X14-P1-A3", text: "O2, גישה ורידית, ניטור", maxScore: 2 },
        { id: "X14-P1-A4", text: "גלוקומטר, ECG", maxScore: 2 },
      ]},
      { id: "X14-P2", title: "טיפול", actions: [
        { id: "X14-P2-A1", text: "Ethanol IV כאנטידוט – מתחרה על alcohol dehydrogenase", maxScore: 2 },
        { id: "X14-P2-A2", text: "נתרן ביקרבונאט לחמצת", maxScore: 2 },
        { id: "X14-P2-A3", text: "Fomepizole 15mg/kg IV (בית חולים)", maxScore: 2 },
        { id: "X14-P2-A4", text: "נוזלים IV, ניטור GCS", maxScore: 2 },
      ]},
      { id: "X14-P3", title: "פינוי", actions: [
        { id: "X14-P3-A1", text: "Pre-alert – methanol, Kussmaul, ראיה, חמצת", maxScore: 2 },
        { id: "X14-P3-A2", text: "פינוי לDialysis center", maxScore: 2 },
        { id: "X14-P3-A3", text: "ניטור ראיה, GCS, חמצת", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X15-P1", title: "הערכה ראשונית", actions: [
        { id: "X15-P1-A1", text: "זיהוי נחש אם בטוח – צילום לא לגעת!", maxScore: 2 },
        { id: "X15-P1-A2", text: "הערכת נפיחות, crepitus, ecchymosis", maxScore: 2 },
        { id: "X15-P1-A3", text: "O2, גישה ורידית x2, ניטור", maxScore: 2 },
        { id: "X15-P1-A4", text: "ECG – ריתמי, QT", maxScore: 2 },
      ]},
      { id: "X15-P2", title: "טיפול", actions: [
        { id: "X15-P2-A1", text: "Immobilize הגפה – מתחת לרמת לב", maxScore: 2 },
        { id: "X15-P2-A2", text: "לא tourniquet, לא חיתוך, לא מציצה!", maxScore: 2 },
        { id: "X15-P2-A3", text: "נוזלים IV לתמיכה המודינמית", maxScore: 2 },
        { id: "X15-P2-A4", text: "Antivenom – בבית חולים בלבד", maxScore: 2 },
      ]},
      { id: "X15-P3", title: "פינוי", actions: [
        { id: "X15-P3-A1", text: "Pre-alert – snake bite, ויפרי?, נפיחות, BP", maxScore: 2 },
        { id: "X15-P3-A2", text: "פינוי לבית חולים עם antivenom", maxScore: 2 },
        { id: "X15-P3-A3", text: "ניטור נפיחות, BP, coagulopathy", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X16-P1", title: "הערכה ראשונית", actions: [
        { id: "X16-P1-A1", text: "עקרב בישראל – Scorpio maurus, Androctonus", maxScore: 2 },
        { id: "X16-P1-A2", text: "הערכת תסמינים – local vs systemic", maxScore: 2 },
        { id: "X16-P1-A3", text: "O2, גישה ורידית/IO, ניטור", maxScore: 2 },
        { id: "X16-P1-A4", text: "ECG – ריתמי, autonomic signs", maxScore: 2 },
      ]},
      { id: "X16-P2", title: "טיפול", actions: [
        { id: "X16-P2-A1", text: "אנלגזיה IV לכאב מקומי", maxScore: 2 },
        { id: "X16-P2-A2", text: "בנזודיאזפין לעוויתות", maxScore: 2 },
        { id: "X16-P2-A3", text: "O2 לפי SpO2", maxScore: 2 },
        { id: "X16-P2-A4", text: "אנטי-וונום בבית חולים – כשיש systemic signs", maxScore: 2 },
      ]},
      { id: "X16-P3", title: "פינוי", actions: [
        { id: "X16-P3-A1", text: "Pre-alert – scorpion envenomation ילד, systemic, עוויתות", maxScore: 2 },
        { id: "X16-P3-A2", text: "פינוי לבית חולים – antivenom, ICU", maxScore: 2 },
        { id: "X16-P3-A3", text: "ניטור ECG, GCS, עוויתות", maxScore: 2 },
      ]},
    ],
  ...
  },
  {
    ...
    phases: [
      { id: "X17-P1", title: "הערכה ראשונית", actions: [
        { id: "X17-P1-A1", text: "SLUDGE – Salivation, Lacrimation, Urination, Defecation, GI, Emesis", maxScore: 2 },
        { id: "X17-P1-A2", text: "מיוזיס, Nicotinic signs – muscle fasciculations", maxScore: 2 },
        { id: "X17-P1-A3", text: "O2, ניהול airway, שאיבה", maxScore: 2 },
        { id: "X17-P1-A4", text: "הגנה על הצוות – כפפות, הסרת בגדים", maxScore: 2 },
      ]},
      { id: "X17-P2", title: "טיפול", actions: [
        { id: "X17-P2-A1", text: "אטרופין 2-4mg IV – חזרה כל 5 דקות עד דיסה", maxScore: 2 },
        { id: "X17-P2-A2", text: "Pralidoxime (2-PAM) 1-2g IV – within 48h", maxScore: 2 },
        { id: "X17-P2-A3", text: "RSI – succinylcholine – זהיר (fasiculations)", maxScore: 2 },
        { id: "X17-P2-A4", text: "decontamination – הסרת בגדים, שטיפה", maxScore: 2 },
      ]},
      { id: "X17-P3", title: "פינוי", actions: [
        { id: "X17-P3-A1", text: "Pre-alert – organophosphate, SLUDGE, אטרופין, decon", maxScore: 2 },
        { id: "X17-P3-A2", text: "פינוי לICU – המשך אטרופין", maxScore: 2 },
        { id: "X17-P3-A3", text: "ניטור SpO2, HR, secretions", maxScore: 2 },
      ]},
    ],
